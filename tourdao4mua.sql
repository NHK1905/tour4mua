...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th5 25, 2022 lúc 03:27 AM
...
--
-- Cơ sở dữ liệu: `tourdao4mua`
--

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_authors`
--

CREATE TABLE `biv_authors` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_authors`
--

INSERT INTO `biv_authors` (`admin_id`, `editor`, `lev`, `files_level`, `position`, `main_module`, `admin_theme`, `addtime`, `edittime`, `is_suspend`, `susp_reason`, `pre_check_num`, `pre_last_login`, `pre_last_ip`, `pre_last_agent`, `check_num`, `last_login`, `last_ip`, `last_agent`) VALUES
(1, 'ckeditor', 1, 'adobe,archives,audio,documents,flash,images,real,video|1|1|1', 'Administrator', 'siteinfo', '', 0, 0, 0, '', '', 0, '', '', '41651ecdcded826168c9f9e4614258f0', 1653443839, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.67 Safari/537.36');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_authors_api_credential`
--

CREATE TABLE `biv_authors_api_credential` (
  `admin_id` int UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_authors_api_role`
--

CREATE TABLE `biv_authors_api_role` (
...
--
-- Cấu trúc bảng cho bảng `biv_authors_config`
--

CREATE TABLE `biv_authors_config` (
...
--
-- Cấu trúc bảng cho bảng `biv_authors_module`
--

CREATE TABLE `biv_authors_module` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_authors_module`
--

INSERT INTO `biv_authors_module` (`mid`, `module`, `lang_key`, `weight`, `act_1`, `act_2`, `act_3`, `checksum`) VALUES
(1, 'siteinfo', 'mod_siteinfo', 1, 1, 1, 1, '0531017adc02888319bdd40733a078f4'),
(2, 'authors', 'mod_authors', 2, 1, 1, 1, 'c07a897b011d3a8e04df5cab4a3b7e57'),
(3, 'settings', 'mod_settings', 3, 1, 1, 0, '614d112264a94cfcb92a6f89afe3d6ed'),
(4, 'database', 'mod_database', 4, 1, 0, 0, '5713aadadceec55b1d2483879569e3f1'),
(5, 'webtools', 'mod_webtools', 5, 1, 1, 0, '8a589ce96d6ffe0e725bbf24e692816e'),
(6, 'seotools', 'mod_seotools', 6, 1, 1, 0, '46fae9a451477902c19bad4e36d791a5'),
(7, 'language', 'mod_language', 7, 1, 1, 0, '35f5660f7d1db01bc2b48d82191ebe84'),
(8, 'modules', 'mod_modules', 8, 1, 1, 0, '4f9da4ac0e3b7d84986fed6b369845c3'),
(9, 'themes', 'mod_themes', 9, 1, 1, 0, 'a761ed1117e14e132f491a68c9422bf4'),
(10, 'extensions', 'mod_extensions', 10, 1, 0, 0, '9af3e44a7fb0ee28a9e55f1f646ad7b9'),
(11, 'upload', 'mod_upload', 11, 1, 1, 1, 'dd053c708ef172e4020ab1a95d4bc5fe'),
(12, 'zalo', 'mod_zalo', 12, 1, 0, 0, '201cd5d5b90b2c36d585ece56f5c6bd3');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_authors_oauth`
--

CREATE TABLE `biv_authors_oauth` (
  `id` mediumint UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_banners_click`
--

CREATE TABLE `biv_banners_click` (
...
--
-- Cấu trúc bảng cho bảng `biv_banners_plans`
--

CREATE TABLE `biv_banners_plans` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_banners_plans`
--

INSERT INTO `biv_banners_plans` (`id`, `blang`, `title`, `description`, `form`, `width`, `height`, `act`, `require_image`, `uploadtype`, `uploadgroup`, `exp_time`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_banners_rows`
--

CREATE TABLE `biv_banners_rows` (
  `id` mediumint UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_banners_rows`
--

INSERT INTO `biv_banners_rows` (`id`, `title`, `pid`, `clid`, `file_name`, `file_ext`, `file_mime`, `width`, `height`, `file_alt`, `imageforswf`, `click_url`, `target`, `bannerhtml`, `add_time`, `publ_time`, `exp_time`, `hits_total`, `act`, `weight`) VALUES
(1, 'Mid-page advertisement', 1, 1, 'webnhanh.jpg', 'png', 'image/jpeg', 575, 72, '', '', 'http://webnhanh.vn', '_blank', '', 1652690495, 1652690495, 0, 0, 1, 1),
(2, 'Left-column advertisement', 2, 1, 'vinades.jpg', 'jpg', 'image/jpeg', 212, 400, '', '', 'http://vinades.vn', '_blank', '', 1652690495, 1652690495, 0, 0, 1, 2);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_config`
--

CREATE TABLE `biv_config` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_config`
--

INSERT INTO `biv_config` (`lang`, `module`, `config_name`, `config_value`) VALUES
...
('vi', 'global', 'site_name', 'TOUR ĐẢO 4 MÙA'),
('vi', 'global', 'site_logo', ''),
...
('vi', 'global', 'cronjobs_next_time', '1653449380'),
...
('vi', 'news', 'per_page', '20'),
('vi', 'news', 'st_links', '10'),
('vi', 'news', 'homewidth', '366'),
('vi', 'news', 'homeheight', '188'),
('vi', 'news', 'blockwidth', '366'),
('vi', 'news', 'blockheight', '188'),
...
('sys', 'site', 'site_email', 'webmaster@tourdao4mua.io'),
('sys', 'global', 'error_set_logs', '1'),
('sys', 'global', 'error_send_email', 'webmaster@tourdao4mua.io'),
('sys', 'global', 'site_lang', 'vi'),
('sys', 'global', 'my_domains', 'tourdao4mua.io'),
('sys', 'global', 'cookie_prefix', 'nv4'),
('sys', 'global', 'session_prefix', 'nv4s_e8fSvx'),
...
('vi', 'trang-chu', 'auto_postcomm', '1'),
('vi', 'trang-chu', 'allowed_comm', '-1'),
('vi', 'trang-chu', 'view_comm', '6'),
('vi', 'trang-chu', 'setcomm', '4'),
('vi', 'trang-chu', 'activecomm', '0'),
('vi', 'trang-chu', 'emailcomm', '0'),
('vi', 'trang-chu', 'adminscomm', ''),
('vi', 'trang-chu', 'sortcomm', '0'),
('vi', 'trang-chu', 'captcha_area_comm', '1'),
('vi', 'trang-chu', 'perpagecomm', '5'),
('vi', 'trang-chu', 'timeoutcomm', '360'),
('vi', 'trang-chu', 'allowattachcomm', '0'),
('vi', 'trang-chu', 'alloweditorcomm', '0');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_cookies`
--

CREATE TABLE `biv_cookies` (
...
--
-- Cấu trúc bảng cho bảng `biv_counter`
--

CREATE TABLE `biv_counter` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_counter`
--

INSERT INTO `biv_counter` (`c_type`, `c_val`, `last_update`, `c_count`, `vi_count`) VALUES
('c_time', 'start', 0, 0, 0),
('c_time', 'last', 0, 1653446432, 0),
('total', 'hits', 1653446432, 45, 45),
('year', '2022', 1653446432, 45, 45),
('year', '2023', 0, 0, 0),
('year', '2024', 0, 0, 0),
('year', '2025', 0, 0, 0),
('year', '2026', 0, 0, 0),
...
('day', '14', 0, 0, 0),
('day', '15', 0, 0, 0),
('day', '16', 1652693783, 2, 2),
('day', '17', 1652782258, 5, 5),
('day', '18', 1652867760, 4, 4),
('day', '19', 1652955314, 4, 4),
('day', '20', 1653035658, 1, 1),
('day', '21', 1653132602, 11, 11),
('day', '22', 0, 0, 0),
('day', '23', 1653297256, 6, 6),
('day', '24', 1653384581, 9, 9),
('day', '25', 1653446432, 3, 3),
('day', '26', 0, 0, 0),
('day', '27', 0, 0, 0),
('day', '28', 0, 0, 0),
('day', '29', 0, 0, 0),
...
('dayofweek', 'Monday', 1653297256, 8, 8),
('dayofweek', 'Tuesday', 1653384581, 14, 14),
('dayofweek', 'Wednesday', 1653446432, 7, 7),
('dayofweek', 'Thursday', 1652955314, 4, 4),
('dayofweek', 'Friday', 1653035658, 1, 1),
('dayofweek', 'Saturday', 1653132602, 11, 11),
('hour', '00', 0, 0, 0),
('hour', '01', 0, 0, 0),
('hour', '02', 0, 0, 0),
('hour', '03', 0, 0, 0),
...
('hour', '05', 0, 0, 0),
('hour', '06', 0, 0, 0),
('hour', '07', 1653440267, 1, 1),
('hour', '08', 1653443867, 1, 1),
('hour', '09', 1653446432, 1, 1),
('hour', '10', 1653364042, 0, 0),
('hour', '11', 1653366014, 0, 0),
('hour', '12', 0, 0, 0),
('hour', '13', 1653374247, 0, 0),
('hour', '14', 1653119670, 0, 0),
('hour', '15', 1653380580, 0, 0),
('hour', '16', 1653384581, 0, 0),
('hour', '17', 1652955314, 0, 0),
('hour', '18', 1653132602, 0, 0),
('hour', '19', 0, 0, 0),
('hour', '20', 0, 0, 0),
('hour', '21', 0, 0, 0),
('hour', '22', 0, 0, 0),
...
('browser', 'ipod', 0, 0, 0),
('browser', 'ipad', 0, 0, 0),
('browser', 'chrome', 1653446432, 44, 44),
('browser', 'cococ', 0, 0, 0),
...
('browser', 'bots', 0, 0, 0),
('browser', 'Unknown', 1652943734, 1, 1),
('os', 'unknown', 0, 0, 0),
('os', 'win', 1652943734, 1, 1),
('os', 'win10', 1653446432, 44, 44),
('os', 'win8', 0, 0, 0),
('os', 'win7', 0, 0, 0),
('os', 'win2003', 0, 0, 0),
('os', 'winvista', 0, 0, 0),
...
('country', 'ZM', 0, 0, 0),
('country', 'ZW', 0, 0, 0),
('country', 'ZZ', 1653446432, 45, 45),
('country', 'unkown', 0, 0, 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_cronjobs`
--

CREATE TABLE `biv_cronjobs` (
  `id` mediumint UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_cronjobs`
--

INSERT INTO `biv_cronjobs` (`id`, `start_time`, `inter_val`, `inter_val_type`, `run_file`, `run_func`, `params`, `del`, `is_sys`, `act`, `last_time`, `last_result`, `vi_cron_name`) VALUES
(1, 1652690495, 5, 0, 'online_expired_del.php', 'cron_online_expired_del', '', 0, 1, 1, 1653449080, 1, 'Xóa các dòng ghi trạng thái online đã cũ trong CSDL'),
(2, 1652690495, 1440, 0, 'dump_autobackup.php', 'cron_dump_autobackup', '', 0, 1, 1, 1653364174, 1, 'Tự động lưu CSDL'),
(3, 1652690495, 60, 0, 'temp_download_destroy.php', 'cron_auto_del_temp_download', '', 0, 1, 1, 1653449080, 1, 'Xóa các file tạm trong thư mục tmp'),
(4, 1652690495, 30, 0, 'ip_logs_destroy.php', 'cron_del_ip_logs', '', 0, 1, 1, 1653449080, 1, 'Xóa IP log files, Xóa các file nhật ký truy cập'),
(5, 1652690495, 1440, 0, 'error_log_destroy.php', 'cron_auto_del_error_log', '', 0, 1, 1, 1653364174, 1, 'Xóa các file error_log quá hạn'),
(6, 1652690495, 360, 0, 'error_log_sendmail.php', 'cron_auto_sendmail_error_log', '', 0, 1, 0, 0, 0, 'Gửi email các thông báo lỗi cho admin'),
(7, 1652690495, 60, 0, 'ref_expired_del.php', 'cron_ref_expired_del', '', 0, 1, 1, 1653449080, 1, 'Xóa các referer quá hạn'),
(8, 1652690495, 60, 0, 'check_version.php', 'cron_auto_check_version', '', 0, 1, 1, 1653449080, 1, 'Kiểm tra phiên bản NukeViet'),
(9, 1652690495, 1440, 0, 'notification_autodel.php', 'cron_notification_autodel', '', 0, 1, 1, 1653364174, 1, 'Xóa thông báo cũ');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_extension_files`
--

CREATE TABLE `biv_extension_files` (
...
--
-- Cấu trúc bảng cho bảng `biv_ips`
--

CREATE TABLE `biv_ips` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_ips`
--

INSERT INTO `biv_ips` (`id`, `type`, `ip`, `mask`, `area`, `begintime`, `endtime`, `notice`) VALUES
(1, 1, '127.0.0.1', 0, 1, 1652690687, 0, '');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_language`
--

CREATE TABLE `biv_language` (
  `id` mediumint UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_language_file`
--

CREATE TABLE `biv_language_file` (
  `idfile` mediumint UNSIGNED NOT NULL,
  `module` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_location_country`
--

CREATE TABLE `biv_location_country` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_location_country`
--

INSERT INTO `biv_location_country` (`countryid`, `code`, `title`, `alias`, `weight`, `status`) VALUES
(1, '84', 'Việt Nam', 'Viet-Nam', 1, 1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_location_district`
--

CREATE TABLE `biv_location_district` (
...
--
-- Cấu trúc bảng cho bảng `biv_location_province`
--

CREATE TABLE `biv_location_province` (
  `provinceid` mediumint UNSIGNED NOT NULL,
  `code` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_location_ward`
--

CREATE TABLE `biv_location_ward` (
  `wardid` mediumint UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_logs`
--

CREATE TABLE `biv_logs` (
  `id` int NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_logs`
--

INSERT INTO `biv_logs` (`id`, `lang`, `module_name`, `name_key`, `note_action`, `link_acess`, `userid`, `log_time`) VALUES
(1, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1652690729),
(2, 'vi', 'themes', 'Thiết lập giao diện theme: \"tour4dao\"', '', '', 1, 1652691755),
(3, 'vi', 'themes', 'Kích hoạt theme: \"tour4dao\"', '', '', 1, 1652691756),
(4, 'vi', 'themes', 'Kích hoạt theme: \"tour4dao\"', '', '', 1, 1652691757),
(5, 'vi', 'themes', 'Kích hoạt theme: \"tour4dao\"', '', '', 1, 1652691758),
(6, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1652779471),
(7, 'vi', 'themes', 'Thiết lập layout theme: \"tour4dao\"', '', '', 1, 1652779485),
(8, 'vi', 'modules', 'Thiết lập module mới slider', '', '', 1, 1652779791),
(9, 'vi', 'modules', 'Sửa module &ldquo;slider&rdquo;', '', '', 1, 1652779795),
(10, 'vi', 'upload', 'Upload file', 'uploads/slider/tour-bana-hills-combo-uu-dai-banner-thang-5-1536x584.jpg', '', 1, 1652779963),
(11, 'vi', 'upload', 'Upload file', 'uploads/slider/baner-ba-na-hills1-cau-vang.jpg', '', 1, 1652779964),
(12, 'vi', 'upload', 'Upload file', 'uploads/slider/baner-tour-bana-hills-2020.jpg', '', 1, 1652779964),
(13, 'vi', 'slider', 'Edit Content', 'ID: 1', '', 1, 1652779982),
(14, 'vi', 'slider', 'Edit Content', 'ID: 1', '', 1, 1652779991),
(15, 'vi', 'slider', 'Edit Content', 'ID: 2', '', 1, 1652780005),
(16, 'vi', 'slider', 'Edit Content', 'ID: 3', '', 1, 1652780015),
(17, 'vi', 'themes', 'Thêm block', 'Name : global slider', '', 1, 1652780066),
(18, 'vi', 'themes', 'Sửa block', 'Name : global slider', '', 1, 1652780117),
(19, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1652862858),
(20, 'vi', 'modules', 'Kích hoạt module \"tours\"', 'Có', '', 1, 1652862910),
(21, 'vi', 'modules', 'Sửa module &ldquo;tours&rdquo;', '', '', 1, 1652862925),
(22, 'vi', 'modules', 'Xóa module \"tours\"', '', '', 1, 1652863209),
(23, 'vi', 'modules', 'Thiết lập module mới booking', '', '', 1, 1652863266),
(24, 'vi', 'modules', 'Sửa module &ldquo;booking&rdquo;', '', '', 1, 1652863281),
(25, 'vi', 'modules', 'Xóa module \"booking\"', '', '', 1, 1652863890),
(26, 'vi', 'modules', 'Kích hoạt module \"location\"', 'Có', '', 1, 1652864125),
(27, 'vi', 'modules', 'Sửa module &ldquo;location&rdquo;', '', '', 1, 1652864137),
(28, 'vi', 'modules', 'Kích hoạt module \"tours\"', 'Có', '', 1, 1652864154),
(29, 'vi', 'modules', 'Sửa module &ldquo;tours&rdquo;', '', '', 1, 1652864164),
(30, 'vi', 'modules', 'Xóa module \"location\"', '', '', 1, 1652865808),
(31, 'vi', 'modules', 'Thiết lập module mới location', '', '', 1, 1652865867),
(32, 'vi', 'modules', 'Sửa module &ldquo;location&rdquo;', '', '', 1, 1652865877),
(33, 'vi', 'location', 'Cấu hình', 'Config', '', 1, 1652866636),
(34, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1652943323),
(35, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1653098355),
(36, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1653100394),
(37, 'vi', 'modules', 'Kích hoạt module \"tours\"', 'Không', '', 1, 1653100773),
(38, 'vi', 'modules', 'Kích hoạt module \"tours\"', 'Có', '', 1, 1653100776),
(39, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1653101091),
(40, 'vi', 'themes', 'Thêm block', 'Name : Tin tiêu điểm', '', 1, 1653104978),
(41, 'vi', 'themes', 'Thêm block', 'Name : Tin mới nhất', '', 1, 1653104993),
(42, 'vi', 'themes', 'Sửa block', 'Name : Tin mới nhất', '', 1, 1653105490),
(43, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1653106551),
(44, 'vi', 'login', '[Admin] Thoát khỏi tài khoản Quản trị', ' Client IP:127.0.0.1', '', 0, 1653108356),
(45, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1653114718),
(46, 'vi', 'login', '[Admin] Thoát khỏi tài khoản Quản trị', ' Client IP:127.0.0.1', '', 0, 1653116524),
(47, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1653117583),
(48, 'vi', 'themes', 'Sửa block', 'Name : Công ty chủ quản', '', 1, 1653117724),
(49, 'vi', 'login', '[Admin] Thoát khỏi tài khoản Quản trị', ' Client IP:127.0.0.1', '', 0, 1653119670),
(50, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1653122314),
(51, 'vi', 'menu', 'Add menu', 'Menu id: 2', '', 1, 1653122399),
(52, 'vi', 'menu', 'Add menu', 'Menu id: 3', '', 1, 1653122408),
(53, 'vi', 'menu', 'Edit menu', 'Menu id: 2', '', 1, 1653122829),
(54, 'vi', 'menu', 'Edit menu', 'Menu id: 3', '', 1, 1653122848),
(55, 'vi', 'menu', 'Add row menu', 'Row menu id: 23 of Menu id: 2', '', 1, 1653122859),
(56, 'vi', 'menu', 'Add row menu', 'Row menu id: 24 of Menu id: 2', '', 1, 1653122867),
(57, 'vi', 'menu', 'Add row menu', 'Row menu id: 25 of Menu id: 2', '', 1, 1653122989),
(58, 'vi', 'menu', 'Add row menu', 'Row menu id: 26 of Menu id: 2', '', 1, 1653122996),
(59, 'vi', 'menu', 'Add row menu', 'Row menu id: 27 of Menu id: 2', '', 1, 1653123003),
(60, 'vi', 'menu', 'Add row menu', 'Row menu id: 28 of Menu id: 2', '', 1, 1653123011),
(61, 'vi', 'menu', 'Add row menu', 'Row menu id: 29 of Menu id: 2', '', 1, 1653123021),
(62, 'vi', 'menu', 'Add row menu', 'Row menu id: 30 of Menu id: 2', '', 1, 1653123031),
(63, 'vi', 'menu', 'Add row menu', 'Row menu id: 31 of Menu id: 2', '', 1, 1653123038),
(64, 'vi', 'menu', 'Add row menu', 'Row menu id: 32 of Menu id: 3', '', 1, 1653123223),
(65, 'vi', 'menu', 'Add row menu', 'Row menu id: 33 of Menu id: 3', '', 1, 1653123232),
(66, 'vi', 'menu', 'Add row menu', 'Row menu id: 34 of Menu id: 3', '', 1, 1653123238),
(67, 'vi', 'menu', 'Add row menu', 'Row menu id: 35 of Menu id: 3', '', 1, 1653123246),
(68, 'vi', 'menu', 'Add row menu', 'Row menu id: 36 of Menu id: 3', '', 1, 1653123254),
(69, 'vi', 'menu', 'Add row menu', 'Row menu id: 37 of Menu id: 3', '', 1, 1653123261),
(70, 'vi', 'menu', 'Add row menu', 'Row menu id: 38 of Menu id: 3', '', 1, 1653123279),
(71, 'vi', 'menu', 'Add row menu', 'Row menu id: 39 of Menu id: 3', '', 1, 1653123300),
(72, 'vi', 'menu', 'Add row menu', 'Row menu id: 40 of Menu id: 3', '', 1, 1653123318),
(73, 'vi', 'themes', 'Sửa block', 'Name : Các chuyên mục chính', '', 1, 1653123344),
(74, 'vi', 'themes', 'Thêm block', 'Name : global treeview', '', 1, 1653123365),
(75, 'vi', 'login', '[Admin] Thoát khỏi tài khoản Quản trị', ' Client IP:127.0.0.1', '', 0, 1653125605),
(76, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1653126268),
(77, 'vi', 'themes', 'Thêm block', 'Name : global copyright', '', 1, 1653126435),
(78, 'vi', 'themes', 'Sửa block', 'Name : global copyright', '', 1, 1653126463),
(79, 'vi', 'themes', 'Sửa block', 'Name : global copyright', '', 1, 1653126479),
(80, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1653277129),
(81, 'vi', 'themes', 'Thiết lập layout theme: \"tour4dao\"', '', '', 1, 1653277139),
(82, 'vi', 'login', '[Admin] Thoát khỏi tài khoản Quản trị', ' Client IP:127.0.0.1', '', 0, 1653278942),
(83, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1653294582),
(84, 'vi', 'modules', 'Thêm module ảo trang_chu', '', '', 1, 1653295127),
(85, 'vi', 'modules', 'Thiết lập module mới shops', '', '', 1, 1653295131),
(86, 'vi', 'modules', 'Sửa module &ldquo;shops&rdquo;', '', '', 1, 1653295157),
(87, 'vi', 'modules', 'Thiết lập module mới trang-chu', '', '', 1, 1653295209),
(88, 'vi', 'modules', 'Sửa module &ldquo;trang-chu&rdquo;', '', '', 1, 1653295216),
(89, 'vi', 'themes', 'Thiết lập layout theme: \"tour4dao\"', '', '', 1, 1653295224),
(90, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1653357136),
(91, 'vi', 'themes', 'Thiết lập layout theme: \"tour4dao\"', '', '', 1, 1653357564),
(92, 'vi', 'themes', 'Thêm block', 'Name : module block news', '', 1, 1653362776),
(93, 'vi', 'themes', 'Sửa block', 'Name : module block news', '', 1, 1653362790),
(94, 'vi', 'themes', 'Sửa block', 'Name : KHUYẾN MÃI TOUR ĐÀ NẴNG', '', 1, 1653362924),
(95, 'vi', 'themes', 'Thiết lập layout theme: \"tour4dao\"', '', '', 1, 1653364190),
(96, 'vi', 'login', '[Admin] Thoát khỏi tài khoản Quản trị', ' Client IP:127.0.0.1', '', 0, 1653366007),
(97, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1653377313),
(98, 'vi', 'login', '[Admin] Thoát khỏi tài khoản Quản trị', ' Client IP:127.0.0.1', '', 0, 1653379147),
(99, 'vi', 'login', '[Admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1653443839),
(100, 'vi', 'themes', 'Thiết lập layout theme: \"tour4dao\"', '', '', 1, 1653443864);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_notification`
--

CREATE TABLE `biv_notification` (
  `id` int UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_notification`
--

INSERT INTO `biv_notification` (`id`, `admin_view_allowed`, `logic_mode`, `send_to`, `send_from`, `area`, `language`, `module`, `obid`, `type`, `content`, `add_time`, `view`) VALUES
(1, 0, 0, '', 1, 1, 'vi', 'contact', 1, 'contact_new', 'a:1:{s:5:\"title\";s:7:\"sadsdas\";}', 1653443989, 0),
(2, 0, 0, '', 1, 1, 'vi', 'contact', 2, 'contact_new', 'a:1:{s:5:\"title\";s:13:\"sdasdfasfdasf\";}', 1653444018, 0),
(3, 0, 0, '', 1, 1, 'vi', 'contact', 3, 'contact_new', 'a:1:{s:5:\"title\";s:7:\"sadsdas\";}', 1653444061, 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_plugin`
--

CREATE TABLE `biv_plugin` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_plugin`
--

INSERT INTO `biv_plugin` (`pid`, `plugin_file`, `plugin_area`, `weight`) VALUES
(1, 'qrcode.php', 1, 1),
...
--
-- Cấu trúc bảng cho bảng `biv_sessions`
--

CREATE TABLE `biv_sessions` (
...
--
-- Cấu trúc bảng cho bảng `biv_setup_extensions`
--

CREATE TABLE `biv_setup_extensions` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_setup_extensions`
--

INSERT INTO `biv_setup_extensions` (`id`, `type`, `title`, `is_sys`, `is_virtual`, `basename`, `table_prefix`, `version`, `addtime`, `author`, `note`) VALUES
(0, 'module', 'about', 0, 0, 'page', 'about', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(0, 'module', 'siteterms', 0, 0, 'page', 'siteterms', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(19, 'module', 'banners', 1, 0, 'banners', 'banners', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(20, 'module', 'contact', 0, 1, 'contact', 'contact', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(1, 'module', 'news', 0, 1, 'news', 'news', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(21, 'module', 'voting', 0, 0, 'voting', 'voting', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(0, 'module', 'slider', 0, 1, 'slider', 'slider', '4.1.02 1501865999', 1652779786, 'Việt Tí (quocvietposcovn@gmail.com)', ''),
(284, 'module', 'seek', 1, 0, 'seek', 'seek', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(24, 'module', 'users', 1, 1, 'users', 'users', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(27, 'module', 'statistics', 0, 0, 'statistics', 'statistics', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(29, 'module', 'menu', 0, 0, 'menu', 'menu', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(283, 'module', 'feeds', 1, 0, 'feeds', 'feeds', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(282, 'module', 'page', 1, 1, 'page', 'page', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(281, 'module', 'comment', 1, 0, 'comment', 'comment', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(312, 'module', 'freecontent', 0, 1, 'freecontent', 'freecontent', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(327, 'module', 'two-step-verification', 1, 0, 'two-step-verification', 'two_step_verification', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(307, 'theme', 'default', 0, 0, 'default', 'default', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(311, 'theme', 'mobile_default', 0, 0, 'mobile_default', 'mobile_default', '4.5.01 1636189200', 1652690495, 'VINADES <contact@vinades.vn>', ''),
(0, 'theme', 'tour4dao', 0, 0, 'tour4dao', 'tour4dao', '4.5.01 1652863219', 1652863219, 'VINADES.,JSC', 'Đây là giao diện mặc định của hệ thống. Bạn không được xóa, đổi tên và không nên sửa trực tiếp vào giao diện này. Nếu muốn, hãy copy thành giao diện khác và kích hoạt sử dụng giao diện mới đó để chỉnh sửa và sử dụng.'),
(0, 'module', 'location', 0, 0, 'location', 'location', '1.0.03 1450249525', 1652865866, 'mynukeviet (contact@mynukeviet.net)', 'Module địa điểm'),
(0, 'module', 'tours', 0, 1, 'tours', 'tours', '2.0.02 1462693377', 1652864045, 'hongoctrien (contact@mynukeviet.net)', ''),
(0, 'module', 'trang-chu', 0, 0, 'page', 'trang_chu', '', 1653295127, '', ''),
(0, 'module', 'shops', 0, 1, 'shops', 'shops', '4.3.00 1492476600', 1653295127, 'VINADES <contact@vinades.vn>', '');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_setup_language`
--

CREATE TABLE `biv_setup_language` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_setup_language`
--

INSERT INTO `biv_setup_language` (`lang`, `setup`, `weight`) VALUES
('vi', 1, 1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_shops_block`
--

CREATE TABLE `biv_shops_block` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_shops_block`
--

INSERT INTO `biv_shops_block` (`bid`, `id`, `weight`) VALUES
(1, 11, 5),
(1, 10, 4),
(1, 9, 3),
(1, 6, 2),
...
--
-- Cấu trúc bảng cho bảng `biv_shops_block_cat`
--

CREATE TABLE `biv_shops_block_cat` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_shops_block_cat`
--

INSERT INTO `biv_shops_block_cat` (`bid`, `adddefault`, `image`, `weight`, `add_time`, `edit_time`, `vi_title`, `vi_alias`, `vi_description`, `vi_bodytext`, `vi_keywords`, `vi_tag_title`, `vi_tag_description`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_shops_carrier`
--

CREATE TABLE `biv_shops_carrier` (
...
--
-- Cấu trúc bảng cho bảng `biv_shops_carrier_config`
--

CREATE TABLE `biv_shops_carrier_config` (
  `id` tinyint UNSIGNED NOT NULL,
  `title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `weight` tinyint UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_shops_carrier_config_items`
--

CREATE TABLE `biv_shops_carrier_config_items` (
  `id` smallint UNSIGNED NOT NULL,
  `cid` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_shops_carrier_config_location`
--

CREATE TABLE `biv_shops_carrier_config_location` (
  `cid` tinyint UNSIGNED NOT NULL,
  `iid` smallint UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_shops_carrier_config_weight`
--

CREATE TABLE `biv_shops_carrier_config_weight` (
  `iid` smallint UNSIGNED NOT NULL,
...
CREATE TABLE `biv_shops_catalogs` (
  ...
  `newday` tinyint NOT NULL DEFAULT '3',
  `typeprice` tinyint NOT NULL DEFAULT '2',
  `form` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `group_price` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `viewdescriptionhtml` tinyint UNSIGNED NOT NULL DEFAULT '0',
  ...
  `cat_number_point` tinyint NOT NULL DEFAULT '0',
  `cat_number_product` tinyint NOT NULL DEFAULT '0',
  `vi_title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Đang đổ dữ liệu cho bảng `biv_shops_catalogs`
--

INSERT INTO `biv_shops_catalogs` (`catid`, `parentid`, `image`, `weight`, `sort`, `lev`, `viewcat`, `numsubcat`, `subcatid`, `inhome`, `numlinks`, `newday`, `typeprice`, `form`, `group_price`, `viewdescriptionhtml`, `admins`, `add_time`, `edit_time`, `groups_view`, `cat_allow_point`, `cat_number_point`, `cat_number_product`, `vi_title`, `vi_title_custom`, `vi_alias`, `vi_description`, `vi_descriptionhtml`, `vi_keywords`, `vi_tag_description`) VALUES
(2, 0, '', 1, 1, 0, 'viewlist', 4, '6,7,8,9', 1, 4, 7, 1, '', '', 0, '', 1432362728, 1432362803, '6', 0, 0, 0, 'Váy', 'Váy', 'Vay-nu', '', '', 'váy, vay', NULL),
(3, 0, '', 2, 6, 0, 'viewlist', 4, '13,14,15,16', 1, 4, 7, 1, '', '', 0, '', 1432362789, 1432362789, '6', 0, 0, 0, 'Giày dép', 'Giày dép', 'Giay-dep', '', '', 'giay, dep, giày, dép', NULL),
(4, 0, '', 3, 11, 0, 'viewlist', 3, '10,11,12', 1, 4, 7, 1, '', '', 0, '', 1432362835, 1432364806, '6', 0, 0, 0, 'Áo', 'Áo', 'Ao', '', '', 'áo, ao', NULL),
(5, 0, '', 4, 15, 0, 'viewlist', 5, '18,19,20,21,22', 1, 4, 7, 1, '', '', 0, '', 1432362887, 1432362887, '6', 0, 0, 0, 'Phụ kiện', 'Phụ kiện', 'Phu-kien', '', '', 'Phụ kiện, Phu kien, kiện, kien, phu kien', NULL),
(6, 2, '', 1, 2, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432364675, 1432364675, '6', 0, 0, 0, 'váy dài', 'váy dài', 'vay-dai', '', '', 'váy dài, dài, vay dai', NULL),
(7, 2, '', 2, 3, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432364695, 1432364695, '6', 0, 0, 0, 'váy ngắn', 'váy ngắn', 'vay-ngan', '', '', 'váy ngắn, vay ngan', NULL),
(8, 2, '', 3, 4, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432364752, 1432364752, '6', 0, 0, 0, 'đầm maxi', 'đầm maxi', 'dam-maxi', '', '', 'đầm, maxi, Maxi, đầm maxi, Đầm maxi', NULL),
(9, 2, '', 4, 5, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432364786, 1432364786, '6', 0, 0, 0, 'Váy chữ A', 'Váy chữ A', 'Vay-chu-A', '', '', 'Váy chữ A, váy chữ a', NULL),
(10, 4, '', 1, 12, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432364825, 1432364863, '6', 0, 0, 0, 'Áo sơmi', 'Áo sơmi', 'Ao-somi', '', '', 'Áo sơmi,, sơmi. áo', NULL),
(11, 4, '', 2, 13, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432364880, 1432364880, '6', 0, 0, 0, 'Áo phông', 'Áo phông', 'Ao-phong', '', '', '', NULL),
(12, 4, '', 3, 14, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432364936, 1432364936, '6', 0, 0, 0, 'Áo dáng dài', 'Áo dáng dài', 'Ao-dang-dai', '', '', 'Áo dáng dài, áo', NULL),
(13, 3, '', 1, 7, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432364976, 1432364976, '6', 0, 0, 0, 'Giày cao gót', 'Giày cao gót', 'Giay-cao-got', '', '', 'Giày cao gót, cao gót, cao got', NULL),
(14, 3, '', 2, 8, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432365033, 1432365033, '6', 0, 0, 0, 'Giày sandal', 'Giày sandal', 'Giay-sandal', '', '', 'sandal, Sandal, giày, giày sandal', NULL),
(15, 3, '', 3, 9, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432365081, 1432365081, '6', 0, 0, 0, 'Giày búp bê', 'Giày búp bê', 'Giay-bup-be', '', '', 'giày búp bê, Giày búp bê, giay bup be, Giay bup be, búp bê, bup be', NULL),
(16, 3, '', 4, 10, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432365108, 1432365108, '6', 0, 0, 0, 'Giày vải', 'Giày vải', 'Giay-vai', '', '', 'vải, giày vải, giay vai', NULL),
(19, 5, '', 2, 17, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432365211, 1432365211, '6', 0, 0, 0, 'Lắc tay', 'Lắc tay', 'Lac-tay', '', '', 'Lắc tay. lac tay, lắc', NULL),
(18, 5, '', 1, 16, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432365185, 1432365185, '6', 0, 0, 0, 'Vòng cổ', 'Vòng cổ', 'Phu-kien-Vong-co', '', '', 'vòng cổ, Vòng cổ, vong co', NULL),
(20, 5, '', 3, 18, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432365242, 1432365242, '6', 0, 0, 0, 'Thắt lưng', 'Thắt lưng', 'That-lung', '', '', 'Thắt lưng, that lung, thắt lưng', NULL),
(21, 5, '', 4, 19, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432365281, 1432365281, '6', 0, 0, 0, 'Đồng hồ', 'Đồng hồ', 'Dong-ho', '', '', 'Đồng hồ, hồ, dong ho', NULL),
(22, 5, '', 5, 20, 1, 'viewlist', 0, '', 1, 4, 7, 1, '', '', 0, '', 1432365303, 1432365303, '6', 0, 0, 0, 'Ví nữ', 'Ví nữ', 'Vi-nu', '', '', 'ví nữ, ví', NULL);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_shops_coupons`
--

CREATE TABLE `biv_shops_coupons` (
  `id` int NOT NULL,
  ...
  `uses_per_coupon` int UNSIGNED NOT NULL DEFAULT '0',
  `uses_per_coupon_count` int NOT NULL DEFAULT '0',
...
--
-- Cấu trúc bảng cho bảng `biv_shops_coupons_history`
--

CREATE TABLE `biv_shops_coupons_history` (
  `id` int NOT NULL,
  `cid` int NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_shops_coupons_product`
--

CREATE TABLE `biv_shops_coupons_product` (
...
--
-- Cấu trúc bảng cho bảng `biv_shops_discounts`
--

CREATE TABLE `biv_shops_discounts` (
...
--
-- Cấu trúc bảng cho bảng `biv_shops_field`
--

CREATE TABLE `biv_shops_field` (
...
--
-- Cấu trúc bảng cho bảng `biv_shops_field_value_vi`
--

CREATE TABLE `biv_shops_field_value_vi` (
  `id` mediumint UNSIGNED NOT NULL,
  `rows_id` int UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_shops_files`
--

CREATE TABLE `biv_shops_files` (
  `id` mediumint UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_shops_files_rows`
--

CREATE TABLE `biv_shops_files_rows` (
  `id_rows` int UNSIGNED NOT NULL,
  `id_files` mediumint UNSIGNED NOT NULL,
  `download_hits` mediumint UNSIGNED NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_shops_group`
--

CREATE TABLE `biv_shops_group` (
  ...
  `numsubgroup` int NOT NULL DEFAULT '0',
  `subgroupid` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `inhome` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `indetail` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `add_time` int UNSIGNED NOT NULL DEFAULT '0',
  `edit_time` int UNSIGNED NOT NULL DEFAULT '0',
  `numpro` int UNSIGNED NOT NULL DEFAULT '0',
  `in_order` tinyint NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `biv_shops_group`
--

INSERT INTO `biv_shops_group` (`groupid`, `parentid`, `image`, `weight`, `sort`, `lev`, `viewgroup`, `numsubgroup`, `subgroupid`, `inhome`, `indetail`, `add_time`, `edit_time`, `numpro`, `in_order`, `is_require`, `vi_title`, `vi_alias`, `vi_description`, `vi_keywords`) VALUES
...
(7, 1, '', 2, 3, 1, 'viewlist', 0, '', 1, 0, 1432626882, 1432626882, 3, 1, 0, 'ZARA', 'ZARA', '', ''),
...
(16, 2, '', 4, 12, 1, 'viewlist', 0, '', 1, 0, 1432627102, 1432627102, 1, 1, 0, 'HỒNG PHẤN', 'HONG-PHAN', '', ''),
...
(35, 3, '', 11, 32, 1, 'viewlist', 0, '', 1, 0, 1432627274, 1432627274, 3, 1, 0, '38', '38', '', ''),
...
(51, 5, '', 4, 50, 1, 'viewlist', 0, '', 1, 0, 1432627528, 1432627528, 1, 1, 0, 'NHẬT BẢN', 'NHAT-BAN', '', ''),
(52, 5, '', 5, 51, 1, 'viewlist', 0, '', 1, 0, 1432627541, 1432627541, 0, 1, 0, 'THÁI LAN', 'THAI-LAN', '', ''),
(53, 5, '', 6, 52, 1, 'viewlist', 0, '', 1, 0, 1432627553, 1432627553, 1, 1, 0, 'HONGKONG', 'HONGKONG', '', ''),
...
--
-- Cấu trúc bảng cho bảng `biv_shops_group_cateid`
--

CREATE TABLE `biv_shops_group_cateid` (
  `groupid` mediumint UNSIGNED NOT NULL,
  `cateid` mediumint UNSIGNED NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `biv_shops_group_cateid`
--

INSERT INTO `biv_shops_group_cateid` (`groupid`, `cateid`) VALUES
(1, 2),
(1, 3),
(1, 4),
(1, 5),
...
--
-- Cấu trúc bảng cho bảng `biv_shops_group_items`
--

CREATE TABLE `biv_shops_group_items` (
  `pro_id` int UNSIGNED NOT NULL DEFAULT '0',
  `group_id` int UNSIGNED NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `biv_shops_group_items`
--

INSERT INTO `biv_shops_group_items` (`pro_id`, `group_id`) VALUES
(9, 7),
(9, 24),
(9, 32),
(9, 33),
...
--
-- Cấu trúc bảng cho bảng `biv_shops_group_quantity`
--

CREATE TABLE `biv_shops_group_quantity` (
  `pro_id` int UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `biv_shops_group_quantity`
--

INSERT INTO `biv_shops_group_quantity` (`pro_id`, `listgroup`, `quantity`) VALUES
(11, '7,24,35', 20),
(10, '7,16,33,51', 10),
(9, '7,24,35,53', 10);
...
--
-- Cấu trúc bảng cho bảng `biv_shops_location`
--

CREATE TABLE `biv_shops_location` (
  `id` mediumint UNSIGNED NOT NULL,
  `parentid` mediumint UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `weight` smallint UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Cấu trúc bảng cho bảng `biv_shops_money_vi`
--

CREATE TABLE `biv_shops_money_vi` (
  `id` mediumint NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_shops_money_vi`
--

INSERT INTO `biv_shops_money_vi` (`id`, `code`, `currency`, `symbol`, `exchange`, `round`, `number_format`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_shops_orders`
--

CREATE TABLE `biv_shops_orders` (
  ...
  `who_is` int UNSIGNED NOT NULL DEFAULT '0',
  ...
  `order_view` tinyint NOT NULL DEFAULT '0',
...
--
-- Cấu trúc bảng cho bảng `biv_shops_orders_id`
--

CREATE TABLE `biv_shops_orders_id` (
  `id` int UNSIGNED NOT NULL,
  `order_id` int NOT NULL,
  `listgroupid` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `proid` mediumint NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_shops_orders_id_group`
--

CREATE TABLE `biv_shops_orders_id_group` (
...
--
-- Cấu trúc bảng cho bảng `biv_shops_orders_shipping`
--

CREATE TABLE `biv_shops_orders_shipping` (
  `id` mediumint UNSIGNED NOT NULL,
  `order_id` int UNSIGNED NOT NULL,
  `ship_name` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ship_phone` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ship_location_id` mediumint UNSIGNED NOT NULL,
  `ship_address_extend` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ship_shops_id` tinyint UNSIGNED NOT NULL,
  `ship_carrier_id` tinyint UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_shops_point`
--

CREATE TABLE `biv_shops_point` (
...
--
-- Cấu trúc bảng cho bảng `biv_shops_point_history`
--

CREATE TABLE `biv_shops_point_history` (
  `id` int NOT NULL,
  `userid` int NOT NULL DEFAULT '0',
  `order_id` int NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_shops_point_queue`
--

CREATE TABLE `biv_shops_point_queue` (
  `order_id` int NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_shops_review`
--

CREATE TABLE `biv_shops_review` (
...
--
-- Cấu trúc bảng cho bảng `biv_shops_rows`
--

CREATE TABLE `biv_shops_rows` (
  `id` int UNSIGNED NOT NULL,
  `listcatid` int NOT NULL DEFAULT '0',
  `array_catid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `copyright` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `gift_from` int UNSIGNED NOT NULL DEFAULT '0',
  `gift_to` int UNSIGNED NOT NULL DEFAULT '0',
  `inhome` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `allowed_comm` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `allowed_rating` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `ratingdetail` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `allowed_send` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `allowed_print` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `allowed_save` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `hitstotal` mediumint UNSIGNED NOT NULL DEFAULT '0',
  `hitscm` mediumint UNSIGNED NOT NULL DEFAULT '0',
  `hitslm` mediumint UNSIGNED NOT NULL DEFAULT '0',
  `num_sell` mediumint NOT NULL DEFAULT '0',
  `showprice` tinyint NOT NULL DEFAULT '0',
  `vi_title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `vi_alias` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
(10, 13, '', 1, 1432606522, 1432629789, 1, 1432606522, 0, 2, 'S000010', 10, 100000, '', 0, 'VND', 2, 350, 'g', 2, '2015_05/giay-bup-be-ngoi-sao-nhap-khau.jpg', 1, 'Giày cao gót mũi nhọn màu hồng', '', 0, 0, 0, 0, 1, 4, 1, '0', 1, 1, 1, 1, 0, 0, 0, 1, 'Giày cao gót mũi nhọn màu hồng be quý phái', 'Giay-cao-got-mui-nhon-mau-hong-be-quy-phai', 'Giày cao gót mũi nhọn màu hồng be quý phái', 'Sản phẩm thời trang<br  /> <div style=\"text-align:center\"><img alt=\"giay bup be ngoi sao nhap khau\" height=\"800\" src=\"/uploads/shops/2015_05/giay-bup-be-ngoi-sao-nhap-khau.jpg\" width=\"800\" /></div> ', '', '', '', ''),
(7, 11, '', 1, 1432369124, 1432369433, 1, 1432369124, 0, 2, 'S000007', 50, 120000, '', 0, 'VND', 1, 150, 'g', 0, '2015_05/giay-bup-be-ngoi-sao-nhap-khau.jpg', 1, '', '', 0, 0, 0, 0, 1, 4, 1, '0', 1, 1, 1, 2, 0, 0, 0, 1, 'áo thun nữ', 'ao-thun-nu', 'áo thun nữ', 'Sản phẩm thời trang<br  /> <div style=\"text-align:center\"><img alt=\"giay bup be ngoi sao nhap khau\" height=\"800\" src=\"/uploads/shops/2015_05/giay-bup-be-ngoi-sao-nhap-khau.jpg\" width=\"800\" /></div> ', '', '', '', ''),
(11, 15, '', 1, 1432607113, 1435376866, 1, 1432607113, 0, 2, 'S000011', 20, 100000, '', 0, 'VND', 2, 250, 'g', 0, '2015_05/giay-bup-be-ngoi-sao-nhap-khau.jpg', 1, 'GIÀY BÚP BÊ NGÔI SAO NHẬP KHẨU', '', 0, 0, 0, 0, 1, 4, 1, '0', 1, 1, 1, 2, 0, 0, 0, 1, 'GIÀY BÚP BÊ NGÔI SAO NHẬP KHẨU', 'GIAY-BUP-BE-NGOI-SAO-NHAP-KHAU', 'GIÀY BÚP BÊ NGÔI SAO NHẬP KHẨU', 'Sản phẩm thời trang<br  /> <div style=\"text-align:center\"><img alt=\"giay bup be ngoi sao nhap khau\" height=\"800\" src=\"/uploads/shops/2015_05/giay-bup-be-ngoi-sao-nhap-khau.jpg\" width=\"800\" /></div> ', '', '', '', '');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_shops_shops`
--

CREATE TABLE `biv_shops_shops` (
  `id` tinyint UNSIGNED NOT NULL,
  `name` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `location` mediumint UNSIGNED NOT NULL DEFAULT '0',
  `address` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `weight` tinyint UNSIGNED NOT NULL,
  `status` tinyint UNSIGNED NOT NULL
...
--
-- Cấu trúc bảng cho bảng `biv_shops_shops_carrier`
--

CREATE TABLE `biv_shops_shops_carrier` (
  `shops_id` tinyint UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_shops_tabs`
--

CREATE TABLE `biv_shops_tabs` (
  `id` int UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_shops_tabs`
--

INSERT INTO `biv_shops_tabs` (`id`, `icon`, `content`, `weight`, `active`, `vi_title`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_shops_tags_id_vi`
--

CREATE TABLE `biv_shops_tags_id_vi` (
  `id` int NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_shops_tags_id_vi`
--

INSERT INTO `biv_shops_tags_id_vi` (`id`, `tid`, `keyword`) VALUES
(1, 1, 'thời trang'),
(1, 2, 'sang trọng'),
(1, 3, 'phù hợp'),
(1, 4, 'đi chơi'),
...
--
-- Cấu trúc bảng cho bảng `biv_shops_tags_vi`
--

CREATE TABLE `biv_shops_tags_vi` (
  `tid` mediumint UNSIGNED NOT NULL,
  `numpro` mediumint NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `biv_shops_tags_vi`
--

INSERT INTO `biv_shops_tags_vi` (`tid`, `numpro`, `alias`, `image`, `description`, `bodytext`, `keywords`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_shops_template`
--

CREATE TABLE `biv_shops_template` (
  `id` mediumint NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `alias` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `weight` mediumint UNSIGNED NOT NULL DEFAULT '1',
  `vi_title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Cấu trúc bảng cho bảng `biv_shops_transaction`
--

CREATE TABLE `biv_shops_transaction` (
  `transaction_id` int NOT NULL,
  `transaction_time` int NOT NULL DEFAULT '0',
...
--
-- Cấu trúc bảng cho bảng `biv_shops_units`
--

CREATE TABLE `biv_shops_units` (
  `id` int NOT NULL,
  `vi_title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Đang đổ dữ liệu cho bảng `biv_shops_units`
--

INSERT INTO `biv_shops_units` (`id`, `vi_title`, `vi_note`) VALUES
(1, 'cái', ''),
(2, 'đôi', '');
...
--
-- Cấu trúc bảng cho bảng `biv_shops_warehouse`
--

CREATE TABLE `biv_shops_warehouse` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_shops_warehouse`
--

INSERT INTO `biv_shops_warehouse` (`wid`, `title`, `note`, `user_id`, `addtime`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_shops_warehouse_logs`
--

CREATE TABLE `biv_shops_warehouse_logs` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_shops_warehouse_logs`
--

INSERT INTO `biv_shops_warehouse_logs` (`logid`, `wid`, `pro_id`, `quantity`, `price`, `money_unit`) VALUES
(1, 1, 1, 20, 150000, 'VND'),
(2, 2, 2, 50, 250000, 'VND'),
(3, 3, 3, 15, 70000, 'VND'),
(4, 4, 4, 20, 120000, 'VND'),
...
--
-- Cấu trúc bảng cho bảng `biv_shops_warehouse_logs_group`
--

CREATE TABLE `biv_shops_warehouse_logs_group` (
  `id` int UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_shops_warehouse_logs_group`
--

INSERT INTO `biv_shops_warehouse_logs_group` (`id`, `logid`, `listgroup`, `quantity`, `price`, `money_unit`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_shops_weight_vi`
--

CREATE TABLE `biv_shops_weight_vi` (
  `id` tinyint UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_shops_weight_vi`
--

INSERT INTO `biv_shops_weight_vi` (`id`, `code`, `title`, `exchange`, `round`) VALUES
(1, 'g', 'Gram', 1, '0.1'),
...
--
-- Cấu trúc bảng cho bảng `biv_shops_wishlist`
--

CREATE TABLE `biv_shops_wishlist` (
...
--
-- Cấu trúc bảng cho bảng `biv_upload_dir`
--

CREATE TABLE `biv_upload_dir` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_upload_dir`
--

INSERT INTO `biv_upload_dir` (`did`, `dirname`, `time`, `thumb_type`, `thumb_width`, `thumb_height`, `thumb_quality`) VALUES
(0, '', 0, 3, 100, 150, 90),
(1, 'uploads', 0, 0, 0, 0, 0),
...
(17, 'uploads/slider', 1652779955, 0, 0, 0, 0),
(18, 'uploads/slider/image', 0, 0, 0, 0, 0),
(21, 'uploads/location', 0, 0, 0, 0, 0),
(22, 'uploads/shops', 0, 0, 0, 0, 0),
(23, 'uploads/shops/temp_pic', 0, 0, 0, 0, 0),
(24, 'uploads/shops/2022_05', 0, 0, 0, 0, 0),
(25, 'uploads/shops/files', 0, 0, 0, 0, 0),
(26, 'uploads/trang-chu', 0, 0, 0, 0, 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_upload_file`
--

CREATE TABLE `biv_upload_file` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_upload_file`
--

INSERT INTO `biv_upload_file` (`name`, `ext`, `type`, `filesize`, `src`, `srcwidth`, `srcheight`, `sizes`, `userid`, `mtime`, `did`, `title`, `alt`) VALUES
('tour-bana-...jpg', 'jpg', 'image', 192880, 'assets/slider/tour-bana-hills-combo-uu-dai-banner-thang-5-1536x584.jpg', 80, 30, '1500|571', 1, 1652779964, 17, 'tour-bana-hills-combo-uu-dai-banner-thang-5-1536x584.jpg', 'tour bana hills combo uu dai banner THANG 5 1536x584'),
('baner-ba-n...jpg', 'jpg', 'image', 270506, 'assets/slider/baner-ba-na-hills1-cau-vang.jpg', 80, 30, '1500|569', 1, 1652779964, 17, 'baner-ba-na-hills1-cau-vang.jpg', 'baner ba na hills1 cau vang'),
('baner-tour...jpg', 'jpg', 'image', 261240, 'assets/slider/baner-tour-bana-hills-2020.jpg', 80, 35, '1500|657', 1, 1652779965, 17, 'baner-tour-bana-hills-2020.jpg', 'baner tour bana hills 2020');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_users`
--

CREATE TABLE `biv_users` (
  `userid` mediumint UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_users`
--

INSERT INTO `biv_users` (`userid`, `group_id`, `username`, `md5username`, `password`, `email`, `first_name`, `last_name`, `gender`, `photo`, `birthday`, `sig`, `regdate`, `question`, `answer`, `passlostkey`, `view_mail`, `remember`, `in_groups`, `active`, `active2step`, `secretkey`, `checknum`, `last_login`, `last_ip`, `last_agent`, `last_openid`, `last_update`, `idsite`, `safemode`, `safekey`, `email_verification_time`, `active_obj`) VALUES
(1, 1, 'Admin', '21232f297a57a5a743894a0e4a801fc3', '{SSHA512}OhKGi0yiTPJYV1V2hrn77GZorq86/HiD5mJRocJwf7lt7j3MJf8WlmtAC833FhTHzQ1htj/rdHo5962khuEh+DI2MjQ=', 'biv@gmail.com.vn', 'Admin', '', '', '', 0, '', 1652690685, 'Con vật yêu thích là gì?', 'Con mèo', '', 0, 1, '1,4', 1, 0, '', '', 1652690685, '', '', '', 0, 0, 0, '', -3, 'SYSTEM');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_users_backupcodes`
--

CREATE TABLE `biv_users_backupcodes` (
  `userid` mediumint UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_users_config`
--

CREATE TABLE `biv_users_config` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_users_config`
--

INSERT INTO `biv_users_config` (`config`, `content`, `edit_time`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_users_edit`
--

CREATE TABLE `biv_users_edit` (
  `userid` mediumint UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_users_field`
--

CREATE TABLE `biv_users_field` (
  `fid` mediumint NOT NULL,
  `field` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `weight` int UNSIGNED NOT NULL DEFAULT '1',
  `field_type` enum('number','date','textbox','textarea','editor','select','radio','checkbox','multiselect') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'textbox',
...
--
-- Đang đổ dữ liệu cho bảng `biv_users_field`
--

INSERT INTO `biv_users_field` (`fid`, `field`, `weight`, `field_type`, `field_choices`, `sql_choices`, `match_type`, `match_regex`, `func_callback`, `min_length`, `max_length`, `required`, `show_register`, `user_editable`, `show_profile`, `class`, `language`, `default_value`, `is_system`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_users_groups`
--

CREATE TABLE `biv_users_groups` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_users_groups`
--

INSERT INTO `biv_users_groups` (`group_id`, `alias`, `email`, `group_type`, `group_color`, `group_avatar`, `require_2step_admin`, `require_2step_site`, `is_default`, `add_time`, `exp_time`, `weight`, `act`, `idsite`, `numbers`, `siteus`, `config`) VALUES
(1, 'Super-Admin', '', 0, '', '', 0, 0, 0, 1652690495, 0, 1, 1, 0, 1, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(2, 'General-Admin', '', 0, '', '', 0, 0, 0, 1652690495, 0, 2, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(3, 'Module-Admin', '', 0, '', '', 0, 0, 0, 1652690495, 0, 3, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(4, 'Users', '', 0, '', '', 0, 0, 0, 1652690495, 0, 4, 1, 0, 1, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(7, 'New-Users', '', 0, '', '', 0, 0, 0, 1652690495, 0, 5, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(5, 'Guest', '', 0, '', '', 0, 0, 0, 1652690495, 0, 6, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(6, 'All', '', 0, '', '', 0, 0, 0, 1652690495, 0, 7, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(10, 'NukeViet-Fans', '', 2, '', '', 0, 0, 1, 1652690495, 0, 8, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(11, 'NukeViet-Admins', '', 2, '', '', 0, 0, 0, 1652690495, 0, 9, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(12, 'NukeViet-Programmers', '', 1, '', '', 0, 0, 0, 1652690495, 0, 10, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_users_groups_detail`
--

CREATE TABLE `biv_users_groups_detail` (
  `group_id` smallint UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `biv_users_groups_detail`
--

INSERT INTO `biv_users_groups_detail` (`group_id`, `lang`, `title`, `description`, `content`) VALUES
(1, 'vi', 'Super Admin', '', ''),
(2, 'vi', 'General Admin', '', ''),
(3, 'vi', 'Module Admin', '', ''),
(4, 'vi', 'Users', '', ''),
...
--
-- Cấu trúc bảng cho bảng `biv_users_groups_users`
--

CREATE TABLE `biv_users_groups_users` (
  `group_id` smallint UNSIGNED NOT NULL DEFAULT '0',
  `userid` mediumint UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `biv_users_groups_users`
--

INSERT INTO `biv_users_groups_users` (`group_id`, `userid`, `is_leader`, `approved`, `data`, `time_requested`, `time_approved`) VALUES
(1, 1, 1, 1, '0', 1652690685, 1652690685);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_users_info`
--

CREATE TABLE `biv_users_info` (
  `userid` mediumint UNSIGNED NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `biv_users_info`
--

INSERT INTO `biv_users_info` (`userid`) VALUES
(1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_users_openid`
--

CREATE TABLE `biv_users_openid` (
  `userid` mediumint UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Cấu trúc bảng cho bảng `biv_users_question`
--

CREATE TABLE `biv_users_question` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_users_question`
--

INSERT INTO `biv_users_question` (`qid`, `title`, `lang`, `weight`, `add_time`, `edit_time`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_users_reg`
--

CREATE TABLE `biv_users_reg` (
  `userid` mediumint UNSIGNED NOT NULL,
  `username` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `md5username` char(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `password` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Cấu trúc bảng cho bảng `biv_vi_about`
--

CREATE TABLE `biv_vi_about` (
  `id` mediumint UNSIGNED NOT NULL,
  `title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_vi_blocks_groups`
--

CREATE TABLE `biv_vi_blocks_groups` (
  `bid` mediumint UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_blocks_groups`
--

INSERT INTO `biv_vi_blocks_groups` (`bid`, `theme`, `module`, `file_name`, `title`, `link`, `template`, `position`, `exp_time`, `active`, `act`, `groups_view`, `all_func`, `weight`, `config`) VALUES
...
(31, 'tour4dao', 'theme', 'global.company_info.php', 'Công ty chủ quản', '', 'no_title', '[COMPANY_INFO]', 0, '1', 1, '6', 1, 1, 'a:13:{s:12:\"company_name\";s:58:\"Công ty cổ phần phát triển nguồn mở Việt Nam\";s:16:\"company_sortname\";s:12:\"VINADES.,JSC\";s:15:\"company_regcode\";s:0:\"\";s:16:\"company_regplace\";s:0:\"\";s:21:\"company_licensenumber\";s:0:\"\";s:22:\"company_responsibility\";s:0:\"\";s:15:\"company_address\";s:72:\"Phòng 1706 - Tòa nhà CT2 Nàng Hương, 583 Nguyễn Trãi, Hà Nội\";s:15:\"company_showmap\";i:1;s:14:\"company_mapurl\";s:326:\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2634.116366996857!2d105.79399620326203!3d20.9844946314258!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ac93055e2f2f%3A0x91f4b423089193dd!2zQ8O0bmcgdHkgQ-G7lSBwaOG6p24gUGjDoXQgdHJp4buDbiBOZ3Xhu5NuIG3hu58gVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1558315703646!5m2!1svi!2s\";s:13:\"company_phone\";s:74:\"+84-24-85872007&#91;+842485872007&#93;|+84-904762534&#91;+84904762534&#93;\";s:11:\"company_fax\";s:15:\"+84-24-35500914\";s:13:\"company_email\";s:18:\"contact@vinades.vn\";s:15:\"company_website\";s:17:\"http://vinades.vn\";}'),
(32, 'tour4dao', 'contact', 'global.contact_default.php', 'Contact Default', '', 'no_title', '[CONTACT_DEFAULT]', 0, '1', 1, '6', 1, 1, ''),
(33, 'tour4dao', 'freecontent', 'global.free_content.php', 'Sản phẩm', '', 'no_title', '[FEATURED_PRODUCT]', 0, '1', 1, '6', 1, 1, 'a:2:{s:7:\"blockid\";i:1;s:7:\"numrows\";i:2;}'),
(34, 'tour4dao', 'theme', 'global.copyright.php', 'Copyright', '', 'no_title', '[FOOTER_SITE]', 0, '1', 1, '6', 1, 1, 'a:5:{s:12:\"copyright_by\";s:0:\"\";s:13:\"copyright_url\";s:0:\"\";s:9:\"design_by\";s:12:\"VINADES.,JSC\";s:10:\"design_url\";s:18:\"http://vinades.vn/\";s:13:\"siteterms_url\";s:39:\"/index.php?language=vi&amp;nv=siteterms\";}'),
(35, 'tour4dao', 'contact', 'global.contact_form.php', 'Feedback', '', 'no_title', '[FOOTER_SITE]', 0, '1', 1, '6', 1, 2, ''),
(40, 'tour4dao', 'menu', 'global.treeview.php', 'Các chuyên mục chính', '', 'no_title', '[MENU_FOOTER]', 0, '1', 1, '6', 1, 1, 'a:2:{s:6:\"menuid\";i:2;s:12:\"title_length\";i:0;}'),
(55, 'tour4dao', 'menu', 'global.treeview.php', 'global treeview', '', 'no_title', '[MENU_FOOTER_SECOND]', 0, '1', 1, '6', 1, 1, 'a:2:{s:6:\"menuid\";i:3;s:12:\"title_length\";i:0;}'),
(41, 'tour4dao', 'menu', 'global.bootstrap.php', 'Menu Site', '', 'no_title', '[MENU_SITE]', 0, '1', 1, '6', 1, 1, 'a:2:{s:6:\"menuid\";i:1;s:12:\"title_length\";i:0;}'),
(42, 'tour4dao', 'users', 'global.user_button.php', 'Đăng nhập thành viên', '', 'no_title', '[PERSONALAREA]', 0, '1', 1, '6', 1, 1, ''),
(43, 'tour4dao', 'theme', 'global.QR_code.php', 'QR code', '', 'no_title', '[QR_CODE]', 0, '1', 1, '6', 1, 1, ''),
(44, 'tour4dao', 'statistics', 'global.counter_button.php', 'Online button', '', 'no_title', '[QR_CODE]', 0, '1', 1, '6', 1, 2, ''),
(45, 'tour4dao', 'about', 'global.about.php', 'Giới thiệu', '', 'border', '[RIGHT]', 0, '1', 1, '6', 1, 1, ''),
(46, 'tour4dao', 'banners', 'global.banners.php', 'Quảng cáo cột phải', '', 'no_title', '[RIGHT]', 0, '1', 1, '6', 1, 2, 'a:1:{s:12:\"idplanbanner\";i:3;}'),
(47, 'tour4dao', 'voting', 'global.voting_random.php', 'Thăm dò ý kiến', '', 'primary', '[RIGHT]', 0, '1', 1, '6', 1, 3, ''),
(48, 'tour4dao', 'news', 'global.block_tophits.php', 'Tin xem nhiều', '', 'primary', '[RIGHT]', 0, '1', 1, '6', 1, 4, 'a:6:{s:10:\"number_day\";i:3650;s:6:\"numrow\";i:10;s:11:\"showtooltip\";i:1;s:16:\"tooltip_position\";s:6:\"bottom\";s:14:\"tooltip_length\";s:3:\"150\";s:7:\"nocatid\";a:2:{i:0;i:10;i:1;i:11;}}'),
(49, 'tour4dao', 'theme', 'global.social.php', 'Social icon', '', 'no_title', '[SOCIAL_ICONS]', 0, '1', 1, '6', 1, 1, 'a:4:{s:8:\"facebook\";s:32:\"http://www.facebook.com/nukeviet\";s:11:\"google_plus\";s:32:\"https://www.google.com/+nukeviet\";s:7:\"youtube\";s:37:\"https://www.youtube.com/user/nukeviet\";s:7:\"twitter\";s:28:\"https://twitter.com/nukeviet\";}'),
(50, 'tour4dao', 'news', 'module.block_newscenter.php', 'Tin mới nhất', '', 'no_title', '[TOP]', 0, '1', 1, '6', 0, 1, 'a:10:{s:6:\"numrow\";i:6;s:11:\"showtooltip\";i:1;s:16:\"tooltip_position\";s:6:\"bottom\";s:14:\"tooltip_length\";s:3:\"150\";s:12:\"length_title\";i:0;s:15:\"length_hometext\";i:0;s:17:\"length_othertitle\";i:60;s:5:\"width\";i:500;s:6:\"height\";i:0;s:7:\"nocatid\";a:0:{}}'),
(51, 'tour4dao', 'banners', 'global.banners.php', 'Quảng cáo giữa trang', '', 'no_title', '[TOP]', 0, '1', 1, '6', 0, 2, 'a:1:{s:12:\"idplanbanner\";i:1;}'),
(52, 'tour4dao', 'slider', 'global.slider.php', 'global slider', '', 'no_title', '[SLIDER]', 0, '1', 1, '6', 1, 1, 'a:3:{s:7:\"blockid\";i:1;s:7:\"numrows\";i:3;s:6:\"plugin\";s:4:\"nivo\";}'),
(53, 'tour4dao', 'news', 'global.block_groups.php', 'Tin tiêu điểm', '/groups/Tin-tieu-diem/', 'no_title', '[HANDBOOK]', 0, '1', 1, '6', 1, 1, 'a:6:{s:7:\"blockid\";i:1;s:6:\"numrow\";i:3;s:12:\"title_length\";i:0;s:11:\"showtooltip\";i:1;s:16:\"tooltip_position\";s:6:\"bottom\";s:14:\"tooltip_length\";s:1:\"0\";}'),
(54, 'tour4dao', 'news', 'global.block_groups.php', 'Tin mới nhất', '/groups/Tin-moi-nhat/', 'no_title', '[NEWS]', 0, '1', 1, '6', 1, 1, 'a:6:{s:7:\"blockid\";i:2;s:6:\"numrow\";i:3;s:12:\"title_length\";i:0;s:11:\"showtooltip\";i:1;s:16:\"tooltip_position\";s:6:\"bottom\";s:14:\"tooltip_length\";s:1:\"0\";}'),
(56, 'tour4dao', 'theme', 'global.copyright.php', 'global copyright', '', 'no_title', '[COPYRIGHT]', 0, '1', 1, '6', 1, 2, 'a:5:{s:12:\"copyright_by\";s:13:\"BIV Marketing\";s:13:\"copyright_url\";s:0:\"\";s:9:\"design_by\";s:13:\"BIV Marketing\";s:10:\"design_url\";s:19:\"https://biv.com.vn/\";s:13:\"siteterms_url\";s:35:\"/index.php?language=vi&nv=siteterms\";}'),
(57, 'tour4dao', 'news', 'module.block_news.php', 'KHUYẾN MÃI TOUR ĐÀ NẴNG', '', 'block_news_grp_title', '[BLOCK_GRP_NEWS]', 0, '1', 1, '6', 0, 1, 'a:4:{s:6:\"numrow\";i:8;s:11:\"showtooltip\";i:0;s:16:\"tooltip_position\";s:6:\"bottom\";s:14:\"tooltip_length\";s:1:\"0\";}');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_blocks_weight`
--

CREATE TABLE `biv_vi_blocks_weight` (
  `bid` mediumint NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_blocks_weight`
--

INSERT INTO `biv_vi_blocks_weight` (`bid`, `func_id`, `weight`) VALUES
(1, 4, 1),
(2, 4, 2),
(3, 4, 1),
(3, 5, 1),
...
--
-- Cấu trúc bảng cho bảng `biv_vi_comment`
--

CREATE TABLE `biv_vi_comment` (
...
--
-- Cấu trúc bảng cho bảng `biv_vi_contact_department`
--

CREATE TABLE `biv_vi_contact_department` (
  `id` smallint UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_contact_department`
--

INSERT INTO `biv_vi_contact_department` (`id`, `full_name`, `alias`, `image`, `phone`, `fax`, `email`, `address`, `note`, `others`, `cats`, `admins`, `act`, `weight`, `is_default`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_vi_contact_reply`
--

CREATE TABLE `biv_vi_contact_reply` (
...
--
-- Cấu trúc bảng cho bảng `biv_vi_contact_send`
--

CREATE TABLE `biv_vi_contact_send` (
  `id` mediumint UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_contact_send`
--

INSERT INTO `biv_vi_contact_send` (`id`, `cid`, `cat`, `title`, `content`, `send_time`, `sender_id`, `sender_name`, `sender_address`, `sender_email`, `sender_phone`, `sender_ip`, `is_read`, `is_reply`, `is_processed`, `processed_by`, `processed_time`) VALUES
(1, 1, '', 'sadsdas', 'đâsdasdasdasđs', 1653443989, 1, 'Admin', 'sadadsadsadas', 'biv@gmail.com.vn', '213213213213123', '127.0.0.1', 0, 0, 0, 0, 0),
(2, 1, '', 'sdasdfasfdasf', 'ádfasdfasdfasdf', 1653444018, 1, 'Admin', 'fdsafasdfasf', 'biv@gmail.com.vn', '213213213213123', '127.0.0.1', 0, 0, 0, 0, 0),
(3, 1, '', 'sadsdas', 'sdafsadfsadfasdf', 1653444061, 1, 'Admin', 'sadadsadsadas', 'biv@gmail.com.vn', '213213213213123', '127.0.0.1', 0, 0, 0, 0, 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_contact_supporter`
--

CREATE TABLE `biv_vi_contact_supporter` (
  `id` smallint UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_vi_freecontent_blocks`
--

CREATE TABLE `biv_vi_freecontent_blocks` (
  `bid` mediumint UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_freecontent_blocks`
--

INSERT INTO `biv_vi_freecontent_blocks` (`bid`, `title`, `description`) VALUES
(1, 'Sản phẩm', 'Sản phẩm của công ty cổ phần phát triển nguồn mở Việt Nam - VINADES.,JSC');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_freecontent_rows`
--

CREATE TABLE `biv_vi_freecontent_rows` (
  `id` mediumint UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_freecontent_rows`
--

INSERT INTO `biv_vi_freecontent_rows` (`id`, `bid`, `title`, `description`, `link`, `target`, `image`, `start_time`, `end_time`, `status`) VALUES
(1, 1, 'Hệ quản trị nội dung NukeViet', '<ul>\n	<li>Giải thưởng Nhân tài đất Việt 2011, 10.000+ website đang sử dụng</li>\n	<li>Được Bộ GD&amp;ĐT khuyến khích sử dụng trong các cơ sở giáo dục</li>\n	<li>Bộ TT&amp;TT quy định ưu tiên sử dụng trong cơ quan nhà nước</li>\n</ul>', 'http://vinades.vn/vi/san-pham/nukeviet/', '_blank', 'cms.jpg', 1652690495, 0, 1),
(2, 1, 'Cổng thông tin doanh nghiệp', '<ul>\n	<li>Tích hợp bán hàng trực tuyến</li>\n	<li>Tích hợp các nghiệp vụ quản lý (quản lý khách hàng, quản lý nhân sự, quản lý tài liệu)</li>\n</ul>', 'http://vinades.vn/vi/san-pham/Cong-thong-tin-doanh-nghiep-NukeViet-portal/', '_blank', 'portal.jpg', 1652690495, 0, 1),
(3, 1, 'Cổng thông tin Phòng giáo dục, Sở giáo dục', '<ul>\n	<li>Tích hợp chung website hàng trăm trường</li>\n	<li>Tích hợp các ứng dụng trực tuyến (Tra điểm SMS, Tra cứu văn bằng, Học bạ điện tử ...)</li>\n</ul>', 'http://vinades.vn/vi/san-pham/Cong-thong-tin-giao-duc-NukeViet-Edugate/', '_blank', 'edugate.jpg', 1652690495, 0, 1),
(4, 1, 'Tòa soạn báo điện tử chuyên nghiệp', '<ul>\n	<li>Bảo mật đa tầng, phân quyền linh hoạt</li>\n	<li>Hệ thống bóc tin tự động, đăng bài tự động, cùng nhiều chức năng tiên tiến khác...</li>\n</ul>', 'http://vinades.vn/vi/san-pham/Toa-soan-bao-dien-tu/', '_blank', 'toa-soan-dien-tu.jpg', 1652690495, 0, 1),
(5, 1, 'Giải pháp bán hàng trực tuyến', '<ul><li>Tích hợp các tính năng cơ bản bán hàng trực tuyến</li><li>Tích hợp với các cổng thanh toán, ví điện tử trên toàn quốc</li></ul>', 'http://vinades.vn', '_blank', 'shop.jpg', 1652690495, 0, 1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_menu`
--

CREATE TABLE `biv_vi_menu` (
  `id` smallint UNSIGNED NOT NULL,
  `title` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `biv_vi_menu`
--

INSERT INTO `biv_vi_menu` (`id`, `title`) VALUES
(1, 'Top Menu'),
(2, 'TOUR ĐÀ NẴNG'),
(3, 'HƯỚNG DẪN');
...
--
-- Cấu trúc bảng cho bảng `biv_vi_menu_rows`
--

CREATE TABLE `biv_vi_menu_rows` (
  `id` mediumint NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_menu_rows`
--

INSERT INTO `biv_vi_menu_rows` (`id`, `parentid`, `mid`, `title`, `link`, `icon`, `image`, `note`, `weight`, `sort`, `lev`, `subitem`, `groups_view`, `module_name`, `op`, `target`, `css`, `active_type`, `status`) VALUES
...
(23, 0, 2, 'Tour Bà Nà Hills', '', '', '', '', 1, 1, 0, '', '6', '0', '', 1, '', 0, 1),
(24, 0, 2, 'Tour Cù Lao Chàm', '', '', '', '', 2, 2, 0, '', '6', '0', '', 1, '', 0, 1),
(25, 0, 2, 'Tour Ngũ Hành Sơn – Hội An', '', '', '', '', 3, 3, 0, '', '6', '0', '', 1, '', 0, 1),
(26, 0, 2, 'Tour Đà Nẵng Huế', '', '', '', '', 4, 4, 0, '', '6', '0', '', 1, '', 0, 1),
(27, 0, 2, 'Tour Núi Thần Tài', '', '', '', '', 5, 5, 0, '', '6', '0', '', 1, '', 0, 1),
(28, 0, 2, 'Tour VinPearl Land Nam Hội An', '', '', '', '', 6, 6, 0, '', '6', '0', '', 1, '', 0, 1),
(29, 0, 2, 'Tour Rừng Dừa 7 Mẫu', '', '', '', '', 7, 7, 0, '', '6', '0', '', 1, '', 0, 1),
(30, 0, 2, 'Tour Đảo Lý Sơn', '', '', '', '', 8, 8, 0, '', '6', '0', '', 1, '', 0, 1),
(31, 0, 2, 'Tour Thánh Địa Mỹ Sơn', '', '', '', '', 9, 9, 0, '', '6', '0', '', 1, '', 0, 1),
(32, 0, 3, 'Hình Thức Thanh Toán', '', '', '', '', 1, 1, 0, '', '6', '0', '', 1, '', 0, 1),
(33, 0, 3, 'Chính Sách &amp; Điều Khoản', '', '', '', '', 2, 2, 0, '', '6', '0', '', 1, '', 0, 1),
(34, 0, 3, 'Chính Sách Bảo Mật Thông Tin', '', '', '', '', 3, 3, 0, '', '6', '0', '', 1, '', 0, 1),
(35, 0, 3, 'Khiếu Nại Dịch Vụ', '', '', '', '', 4, 4, 0, '', '6', '0', '', 1, '', 0, 1),
(36, 0, 3, 'Chương Trình Khuyễn Mãi', '', '', '', '', 5, 5, 0, '', '6', '0', '', 1, '', 0, 1),
(37, 0, 3, 'Cẩm Nang Du Lịch', '', '', '', '', 6, 6, 0, '', '6', '0', '', 1, '', 0, 1),
(38, 0, 3, 'Liên Hệ Tour Đảo Bốn Mùa', '', '', '', '', 7, 7, 0, '', '6', '0', '', 1, '', 0, 1),
(39, 0, 3, 'Tin Tức Du Lịch', '', '', '', '', 8, 8, 0, '', '6', '0', '', 1, '', 0, 1),
(40, 0, 3, 'Chi Phí Thuê Cano Nha Trang', '', '', '', '', 9, 9, 0, '', '6', '0', '', 1, '', 0, 1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_modfuncs`
--

CREATE TABLE `biv_vi_modfuncs` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_modfuncs`
--

INSERT INTO `biv_vi_modfuncs` (`func_id`, `func_name`, `alias`, `func_custom_name`, `func_site_title`, `in_module`, `show_func`, `in_submenu`, `subweight`, `setting`) VALUES
...
(68, 'main', 'main', 'Main', '', 'location', 1, 0, 1, ''),
(70, 'blockcat', 'blockcat', 'Blockcat', '', 'shops', 1, 0, 17, ''),
(71, 'cart', 'cart', 'Cart', '', 'shops', 1, 0, 5, ''),
(72, 'cat', 'cat', 'Cat', '', 'shops', 0, 0, 0, ''),
(73, 'checkorder', 'checkorder', 'Checkorder', '', 'shops', 0, 0, 0, ''),
(74, 'compare', 'compare', 'Compare', '', 'shops', 1, 0, 11, ''),
(75, 'delhis', 'delhis', 'Delhis', '', 'shops', 0, 0, 0, ''),
(76, 'detail', 'detail', 'Detail', '', 'shops', 1, 0, 3, ''),
(77, 'download', 'download', 'Download', '', 'shops', 1, 0, 16, ''),
(78, 'group', 'group', 'Group', '', 'shops', 1, 0, 9, ''),
(79, 'history', 'history', 'History', '', 'shops', 1, 0, 8, ''),
(80, 'loadcart', 'loadcart', 'Loadcart', '', 'shops', 0, 0, 0, ''),
(81, 'main', 'main', 'Main', '', 'shops', 1, 0, 1, ''),
(82, 'order', 'order', 'Order', '', 'shops', 1, 0, 6, ''),
(83, 'payment', 'payment', 'Payment', '', 'shops', 1, 0, 7, ''),
(84, 'point', 'point', 'Point', '', 'shops', 1, 0, 14, ''),
(85, 'print', 'print', 'Print', '', 'shops', 0, 0, 0, ''),
(86, 'print_pro', 'print_pro', 'Print_pro', '', 'shops', 0, 0, 0, ''),
(87, 'remove', 'remove', 'Remove', '', 'shops', 0, 0, 0, ''),
(88, 'review', 'review', 'Review', '', 'shops', 0, 0, 0, ''),
(89, 'rss', 'rss', 'Rss', '', 'shops', 0, 0, 0, ''),
(90, 'search', 'search', 'Search', '', 'shops', 1, 0, 4, ''),
(91, 'search_result', 'search_result', 'Search_result', '', 'shops', 1, 0, 10, ''),
(92, 'sendmail', 'sendmail', 'Sendmail', '', 'shops', 0, 0, 0, ''),
(93, 'setcart', 'setcart', 'Setcart', '', 'shops', 0, 0, 0, ''),
(94, 'shippingajax', 'shippingajax', 'Shippingajax', '', 'shops', 1, 0, 15, ''),
(95, 'sitemap', 'sitemap', 'Sitemap', '', 'shops', 0, 0, 0, ''),
(96, 'tag', 'tag', 'Tag', '', 'shops', 1, 0, 13, ''),
(97, 'viewcat', 'viewcat', 'Viewcat', '', 'shops', 1, 0, 2, ''),
(98, 'wishlist', 'wishlist', 'Wishlist', '', 'shops', 1, 0, 12, ''),
(99, 'wishlist_update', 'wishlist_update', 'Wishlist_update', '', 'shops', 0, 0, 0, ''),
(100, 'main', 'main', 'Main', '', 'trang-chu', 1, 0, 1, ''),
(101, 'rss', 'rss', 'Rss', '', 'trang-chu', 1, 0, 2, ''),
(102, 'sitemap', 'sitemap', 'Sitemap', '', 'trang-chu', 0, 0, 0, '');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_modthemes`
--

CREATE TABLE `biv_vi_modthemes` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_modthemes`
--

INSERT INTO `biv_vi_modthemes` (`func_id`, `layout`, `theme`) VALUES
(0, 'left-main-right', 'default'),
(0, 'left-main-right', 'tour4dao'),
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_modules`
--

INSERT INTO `biv_vi_modules` (`title`, `module_file`, `module_data`, `module_upload`, `module_theme`, `custom_title`, `site_title`, `admin_title`, `set_time`, `main_file`, `admin_file`, `theme`, `mobile`, `description`, `keywords`, `groups_view`, `weight`, `act`, `admins`, `rss`, `sitemap`) VALUES
('about', 'page', 'about', 'about', 'page', 'Giới thiệu', '', '', 1652690495, 1, 1, '', '', '', '', '6', 1, 1, '', 1, 1),
('news', 'news', 'news', 'news', 'news', 'Tin Tức', '', '', 1652690495, 1, 1, '', '', '', '', '6', 2, 1, '', 1, 1),
('users', 'users', 'users', 'users', 'users', 'Thành viên', '', 'Tài khoản', 1652690495, 1, 1, '', '', '', '', '6', 3, 1, '', 0, 1),
('contact', 'contact', 'contact', 'contact', 'contact', 'Liên hệ', '', '', 1652690495, 1, 1, '', '', '', '', '6', 4, 1, '', 0, 1),
('statistics', 'statistics', 'statistics', 'statistics', 'statistics', 'Thống kê', '', '', 1652690495, 1, 1, '', '', '', 'online, statistics', '6', 5, 1, '', 0, 1),
('voting', 'voting', 'voting', 'voting', 'voting', 'Thăm dò ý kiến', '', '', 1652690495, 1, 1, '', '', '', '', '6', 6, 1, '', 1, 1),
('banners', 'banners', 'banners', 'banners', 'banners', 'Quảng cáo', '', '', 1652690495, 1, 1, '', '', '', '', '6', 7, 1, '', 0, 1),
('seek', 'seek', 'seek', 'seek', 'seek', 'Tìm kiếm', '', '', 1652690495, 1, 0, '', '', '', '', '6', 8, 1, '', 0, 1),
('menu', 'menu', 'menu', 'menu', 'menu', 'Menu Site', '', '', 1652690495, 0, 1, '', '', '', '', '6', 9, 1, '', 0, 1),
('feeds', 'feeds', 'feeds', 'feeds', 'feeds', 'RSS-feeds', '', '', 1652690495, 1, 1, '', '', '', '', '6', 10, 1, '', 0, 1),
('page', 'page', 'page', 'page', 'page', 'Page', '', '', 1652690495, 1, 1, '', '', '', '', '6', 11, 1, '', 1, 0),
('comment', 'comment', 'comment', 'comment', 'comment', 'Bình luận', '', 'Quản lý bình luận', 1652690495, 0, 1, '', '', '', '', '6', 12, 1, '', 0, 1),
('siteterms', 'page', 'siteterms', 'siteterms', 'page', 'Điều khoản sử dụng', '', '', 1652690495, 1, 1, '', '', '', '', '6', 13, 1, '', 1, 1),
('freecontent', 'freecontent', 'freecontent', 'freecontent', 'freecontent', 'Giới thiệu sản phẩm', '', '', 1652690495, 0, 1, '', '', '', '', '6', 14, 1, '', 0, 1),
('two-step-verification', 'two-step-verification', 'two_step_verification', 'two_step_verification', 'two-step-verification', 'Xác thực hai bước', '', '', 1652690495, 1, 0, '', '', '', '', '6', 15, 1, '', 0, 1),
('slider', 'slider', 'slider', 'slider', 'slider', 'Slider', '', 'Quản lí Slider', 1652779791, 0, 1, '', '', '', '', '6', 16, 1, '', 0, 0),
('location', 'location', 'location', 'location', 'location', 'Location', '', 'Quản lí Location', 1652865867, 1, 1, '', '', '', '', '6', 18, 1, '', 0, 0),
('tours', 'tours', 'tours', 'tours', 'tours', 'Tours', '', 'Quản lí Tours', 1652864144, 1, 1, '', '', '', '', '6', 17, 1, '', 1, 1),
('shops', 'shops', 'shops', 'shops', 'shops', 'Tour', '', 'Quản lí Tours', 1653295131, 1, 1, '', '', '', '', '6', 19, 1, '', 1, 1),
('trang-chu', 'page', 'trang_chu', 'trang-chu', 'page', 'Trang chủ', '', 'Trang chủ', 1653295209, 1, 1, '', '', '', '', '6', 20, 1, '', 1, 1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_news_1`
--

CREATE TABLE `biv_vi_news_1` (
  `id` int UNSIGNED NOT NULL,
...
(2, 7, '1,7', 0, 1, 'Nguyễn Thế Hùng', 7, 1453192444, 1453192444, 1, 12, 1453192444, 0, 2, 'Hãy trở thành nhà cung cấp dịch vụ của NukeViet&#33;', 'hay-tro-thanh-nha-cung-cap-dich-vu-cua-nukeviet', 'Nếu bạn là công ty hosting, là công ty thiết kế web có sử dụng mã nguồn NukeViet, là cơ sở đào tạo NukeViet hay là công ty bất kỳ có kinh doanh dịch vụ liên quan đến NukeViet... hãy cho chúng tôi biết thông tin liên hệ của bạn để NukeViet hỗ trợ bạn trong công việc kinh doanh nhé!', 'hoptac.jpg', '', 1, 1, '6', 1, 0, 16, 0, 0, 0, 0, '', 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_news_2`
--

CREATE TABLE `biv_vi_news_2` (
  `id` int UNSIGNED NOT NULL,
  `catid` smallint UNSIGNED NOT NULL DEFAULT '0',
  `listcatid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `topicid` smallint UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_2`
--

INSERT INTO `biv_vi_news_2` (`id`, `catid`, `listcatid`, `topicid`, `admin_id`, `author`, `sourceid`, `addtime`, `edittime`, `status`, `weight`, `publtime`, `exptime`, `archive`, `title`, `alias`, `hometext`, `homeimgfile`, `homeimgalt`, `homeimgthumb`, `inhome`, `allowed_comm`, `allowed_rating`, `external_link`, `hitstotal`, `hitscm`, `total_rating`, `click_rating`, `instant_active`, `instant_template`, `instant_creatauto`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_3`
--

CREATE TABLE `biv_vi_news_3` (
  `id` int UNSIGNED NOT NULL,
  `catid` smallint UNSIGNED NOT NULL DEFAULT '0',
  `listcatid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `topicid` smallint UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_3`
--

INSERT INTO `biv_vi_news_3` (`id`, `catid`, `listcatid`, `topicid`, `admin_id`, `author`, `sourceid`, `addtime`, `edittime`, `status`, `weight`, `publtime`, `exptime`, `archive`, `title`, `alias`, `hometext`, `homeimgfile`, `homeimgalt`, `homeimgthumb`, `inhome`, `allowed_comm`, `allowed_rating`, `external_link`, `hitstotal`, `hitscm`, `total_rating`, `click_rating`, `instant_active`, `instant_template`, `instant_creatauto`) VALUES
(12, 1, '1,3', 0, 1, '', 0, 1445391217, 1445393997, 1, 10, 1445391180, 0, 2, 'Hỗ trợ tập huấn và triển khai NukeViet cho các Phòng, Sở GD&amp;ĐT', 'ho-tro-tap-huan-va-trien-khai-nukeviet-cho-cac-phong-so-gd-dt', 'Trên cơ sở Hướng dẫn thực hiện nhiệm vụ CNTT năm học 2015 - 2016 của Bộ Giáo dục và Đào tạo, Công ty cổ phần phát triển nguồn mở Việt Nam và các doanh nghiệp phát triển NukeViet trong cộng đồng NukeViet đang tích cực công tác hỗ trợ cho các phòng GD&ĐT, Sở GD&ĐT triển khai 2 nội dung chính: Hỗ trợ công tác đào tạo tập huấn hướng dẫn sử dụng NukeViet và Hỗ trợ triển khai NukeViet cho các trường, Phòng và Sở GD&ĐT', 'tap-huan-pgd-ha-dong-2015.jpg', 'Tập huấn triển khai NukeViet tại Phòng Giáo dục và Đào tạo Hà Đông - Hà Nội', 1, 1, '4', 1, 0, 2, 0, 0, 0, 0, '', 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_news_4`
--

CREATE TABLE `biv_vi_news_4` (
  `id` int UNSIGNED NOT NULL,
  `catid` smallint UNSIGNED NOT NULL DEFAULT '0',
  `listcatid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `topicid` smallint UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_4`
--

INSERT INTO `biv_vi_news_4` (`id`, `catid`, `listcatid`, `topicid`, `admin_id`, `author`, `sourceid`, `addtime`, `edittime`, `status`, `weight`, `publtime`, `exptime`, `archive`, `title`, `alias`, `hometext`, `homeimgfile`, `homeimgalt`, `homeimgthumb`, `inhome`, `allowed_comm`, `allowed_rating`, `external_link`, `hitstotal`, `hitscm`, `total_rating`, `click_rating`, `instant_active`, `instant_template`, `instant_creatauto`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_5`
--

CREATE TABLE `biv_vi_news_5` (
  `id` int UNSIGNED NOT NULL,
  `catid` smallint UNSIGNED NOT NULL DEFAULT '0',
  `listcatid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `topicid` smallint UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_5`
--

INSERT INTO `biv_vi_news_5` (`id`, `catid`, `listcatid`, `topicid`, `admin_id`, `author`, `sourceid`, `addtime`, `edittime`, `status`, `weight`, `publtime`, `exptime`, `archive`, `title`, `alias`, `hometext`, `homeimgfile`, `homeimgalt`, `homeimgthumb`, `inhome`, `allowed_comm`, `allowed_rating`, `external_link`, `hitstotal`, `hitscm`, `total_rating`, `click_rating`, `instant_active`, `instant_template`, `instant_creatauto`) VALUES
(1, 1, '1,5,7', 0, 1, 'Quỳnh Nhi', 1, 1274989177, 1275318126, 1, 1, 1274989140, 0, 2, 'Ra mắt công ty mã nguồn mở đầu tiên tại Việt Nam', 'Ra-mat-cong-ty-ma-nguon-mo-dau-tien-tai-Viet-Nam', 'Mã nguồn mở NukeViet vốn đã quá quen thuộc với cộng đồng CNTT Việt Nam trong mấy năm qua. Tuy chưa hoạt động chính thức, nhưng chỉ trong khoảng 5 năm gần đây, mã nguồn mở NukeViet đã được dùng phổ biến ở Việt Nam, áp dụng ở hầu hết các lĩnh vực, từ tin tức đến thương mại điện tử, từ các website cá nhân cho tới những hệ thống website doanh nghiệp.', 'nangly.jpg', 'Thành lập VINADES.,JSC', 1, 1, '6', 1, 0, 2, 0, 0, 0, 0, '', 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_news_6`
--

CREATE TABLE `biv_vi_news_6` (
  `id` int UNSIGNED NOT NULL,
  `catid` smallint UNSIGNED NOT NULL DEFAULT '0',
  `listcatid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `topicid` smallint UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_6`
--

INSERT INTO `biv_vi_news_6` (`id`, `catid`, `listcatid`, `topicid`, `admin_id`, `author`, `sourceid`, `addtime`, `edittime`, `status`, `weight`, `publtime`, `exptime`, `archive`, `title`, `alias`, `hometext`, `homeimgfile`, `homeimgalt`, `homeimgthumb`, `inhome`, `allowed_comm`, `allowed_rating`, `external_link`, `hitstotal`, `hitscm`, `total_rating`, `click_rating`, `instant_active`, `instant_template`, `instant_creatauto`) VALUES
(6, 1, '1,6', 0, 1, '', 3, 1322685920, 1322686042, 1, 2, 1322685920, 0, 2, 'Mã nguồn mở NukeViet giành giải ba Nhân tài đất Việt 2011', 'Ma-nguon-mo-NukeViet-gianh-giai-ba-Nhan-tai-dat-Viet-2011', 'Không có giải nhất và giải nhì, sản phẩm Mã nguồn mở NukeViet của VINADES.,JSC là một trong ba sản phẩm đã đoạt giải ba Nhân tài đất Việt 2011 - Lĩnh vực Công nghệ thông tin (Sản phẩm đã ứng dụng rộng rãi).', 'nukeviet-nhantaidatviet2011.jpg', 'Mã nguồn mở NukeViet giành giải ba Nhân tài đất Việt 2011', 1, 1, '6', 1, 0, 1, 0, 0, 0, 0, '', 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_news_7`
--

CREATE TABLE `biv_vi_news_7` (
  `id` int UNSIGNED NOT NULL,
  `catid` smallint UNSIGNED NOT NULL DEFAULT '0',
  `listcatid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `topicid` smallint UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_7`
--

INSERT INTO `biv_vi_news_7` (`id`, `catid`, `listcatid`, `topicid`, `admin_id`, `author`, `sourceid`, `addtime`, `edittime`, `status`, `weight`, `publtime`, `exptime`, `archive`, `title`, `alias`, `hometext`, `homeimgfile`, `homeimgalt`, `homeimgthumb`, `inhome`, `allowed_comm`, `allowed_rating`, `external_link`, `hitstotal`, `hitscm`, `total_rating`, `click_rating`, `instant_active`, `instant_template`, `instant_creatauto`) VALUES
(1, 1, '1,5,7', 0, 1, 'Quỳnh Nhi', 1, 1274989177, 1275318126, 1, 1, 1274989140, 0, 2, 'Ra mắt công ty mã nguồn mở đầu tiên tại Việt Nam', 'Ra-mat-cong-ty-ma-nguon-mo-dau-tien-tai-Viet-Nam', 'Mã nguồn mở NukeViet vốn đã quá quen thuộc với cộng đồng CNTT Việt Nam trong mấy năm qua. Tuy chưa hoạt động chính thức, nhưng chỉ trong khoảng 5 năm gần đây, mã nguồn mở NukeViet đã được dùng phổ biến ở Việt Nam, áp dụng ở hầu hết các lĩnh vực, từ tin tức đến thương mại điện tử, từ các website cá nhân cho tới những hệ thống website doanh nghiệp.', 'nangly.jpg', 'Thành lập VINADES.,JSC', 1, 1, '6', 1, 0, 2, 0, 0, 0, 0, '', 0),
(2, 7, '1,7', 0, 1, 'Nguyễn Thế Hùng', 7, 1453192444, 1453192444, 1, 12, 1453192444, 0, 2, 'Hãy trở thành nhà cung cấp dịch vụ của NukeViet&#33;', 'hay-tro-thanh-nha-cung-cap-dich-vu-cua-nukeviet', 'Nếu bạn là công ty hosting, là công ty thiết kế web có sử dụng mã nguồn NukeViet, là cơ sở đào tạo NukeViet hay là công ty bất kỳ có kinh doanh dịch vụ liên quan đến NukeViet... hãy cho chúng tôi biết thông tin liên hệ của bạn để NukeViet hỗ trợ bạn trong công việc kinh doanh nhé!', 'hoptac.jpg', '', 1, 1, '6', 1, 0, 16, 0, 0, 0, 0, '', 0);
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_admins`
--

CREATE TABLE `biv_vi_news_admins` (
  `userid` mediumint UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_author`
--

CREATE TABLE `biv_vi_news_author` (
  `id` mediumint UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_author`
--

INSERT INTO `biv_vi_news_author` (`id`, `uid`, `alias`, `pseudonym`, `image`, `description`, `add_time`, `edit_time`, `active`, `numnews`) VALUES
(1, 1, 'Admin', 'Admin', '', '', 1653360345, 0, 1, 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_news_authorlist`
--

CREATE TABLE `biv_vi_news_authorlist` (
  `id` int NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_block`
--

CREATE TABLE `biv_vi_news_block` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_block`
--

INSERT INTO `biv_vi_news_block` (`bid`, `id`, `weight`) VALUES
(1, 1, 1),
(2, 12, 1),
(2, 11, 2),
(2, 10, 3),
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_block_cat`
--

CREATE TABLE `biv_vi_news_block_cat` (
  `bid` smallint UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_block_cat`
--

INSERT INTO `biv_vi_news_block_cat` (`bid`, `adddefault`, `numbers`, `title`, `alias`, `image`, `description`, `weight`, `keywords`, `add_time`, `edit_time`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_cat`
--

CREATE TABLE `biv_vi_news_cat` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_cat`
--

INSERT INTO `biv_vi_news_cat` (`catid`, `parentid`, `title`, `titlesite`, `alias`, `description`, `descriptionhtml`, `image`, `viewdescription`, `weight`, `sort`, `lev`, `viewcat`, `numsubcat`, `subcatid`, `numlinks`, `newday`, `featured`, `ad_block_cat`, `keywords`, `admins`, `add_time`, `edit_time`, `groups_view`, `status`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_config_post`
--

CREATE TABLE `biv_vi_news_config_post` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_config_post`
--

INSERT INTO `biv_vi_news_config_post` (`group_id`, `addcontent`, `postcontent`, `editcontent`, `delcontent`) VALUES
(4, 0, 0, 0, 0),
(7, 0, 0, 0, 0),
(5, 0, 0, 0, 0),
(10, 0, 0, 0, 0),
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_detail`
--

CREATE TABLE `biv_vi_news_detail` (
  `id` int UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_detail`
--

INSERT INTO `biv_vi_news_detail` (`id`, `titlesite`, `description`, `bodyhtml`, `keywords`, `sourcetext`, `files`, `imgposition`, `layout_func`, `copyright`, `allowed_send`, `allowed_print`, `allowed_save`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_logs`
--

CREATE TABLE `biv_vi_news_logs` (
  `id` mediumint UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_rows`
--

CREATE TABLE `biv_vi_news_rows` (
  `id` int UNSIGNED NOT NULL,
  `catid` smallint UNSIGNED NOT NULL DEFAULT '0',
  `listcatid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `topicid` smallint UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_rows`
--

INSERT INTO `biv_vi_news_rows` (`id`, `catid`, `listcatid`, `topicid`, `admin_id`, `author`, `sourceid`, `addtime`, `edittime`, `status`, `weight`, `publtime`, `exptime`, `archive`, `title`, `alias`, `hometext`, `homeimgfile`, `homeimgalt`, `homeimgthumb`, `inhome`, `allowed_comm`, `allowed_rating`, `external_link`, `hitstotal`, `hitscm`, `total_rating`, `click_rating`, `instant_active`, `instant_template`, `instant_creatauto`) VALUES
(1, 1, '1,5,7', 0, 1, 'Quỳnh Nhi', 1, 1274989177, 1275318126, 1, 1, 1274989140, 0, 2, 'Ra mắt công ty mã nguồn mở đầu tiên tại Việt Nam', 'Ra-mat-cong-ty-ma-nguon-mo-dau-tien-tai-Viet-Nam', 'Mã nguồn mở NukeViet vốn đã quá quen thuộc với cộng đồng CNTT Việt Nam trong mấy năm qua. Tuy chưa hoạt động chính thức, nhưng chỉ trong khoảng 5 năm gần đây, mã nguồn mở NukeViet đã được dùng phổ biến ở Việt Nam, áp dụng ở hầu hết các lĩnh vực, từ tin tức đến thương mại điện tử, từ các website cá nhân cho tới những hệ thống website doanh nghiệp.', 'nangly.jpg', 'Thành lập VINADES.,JSC', 1, 1, '6', 1, 0, 2, 0, 0, 0, 0, '', 0),
(2, 7, '1,7', 0, 1, 'Nguyễn Thế Hùng', 7, 1453192444, 1453192444, 1, 12, 1453192444, 0, 2, 'Hãy trở thành nhà cung cấp dịch vụ của NukeViet&#33;', 'hay-tro-thanh-nha-cung-cap-dich-vu-cua-nukeviet', 'Nếu bạn là công ty hosting, là công ty thiết kế web có sử dụng mã nguồn NukeViet, là cơ sở đào tạo NukeViet hay là công ty bất kỳ có kinh doanh dịch vụ liên quan đến NukeViet... hãy cho chúng tôi biết thông tin liên hệ của bạn để NukeViet hỗ trợ bạn trong công việc kinh doanh nhé!', 'hoptac.jpg', '', 1, 1, '6', 1, 0, 16, 0, 0, 0, 0, '', 0),
(3, 4, '4', 0, 1, 'Phạm Quốc Tiến', 2, 1453192400, 1453192400, 1, 11, 1453192400, 0, 2, 'Tuyển dụng lập trình viên PHP phát triển NukeViet', 'Tuyen-dung-lap-trinh-vien-PHP', 'Bạn đam mê nguồn mở? Bạn đang cần tìm một công việc phù hợp với thế mạnh của bạn về PHP và MySQL? Hãy gia nhập VINADES.,JSC để xây dựng mã nguồn mở hàng đầu cho Việt Nam.', 'tuyendung-kythuat.jpg', 'Tuyển dụng', 1, 1, '6', 1, 0, 0, 0, 0, 0, 0, '', 0),
(4, 4, '4', 0, 1, 'Phạm Quốc Tiến', 0, 1445391089, 1445394192, 1, 5, 1445391060, 0, 2, 'Tuyển dụng chuyên viên đồ hoạ phát triển NukeViet', 'Tuyen-dung-chuyen-vien-do-hoa', 'Bạn đam mê nguồn mở? Bạn là chuyên gia đồ họa? Chúng tôi sẽ giúp bạn hiện thực hóa ước mơ của mình với một mức lương đảm bảo. Hãy gia nhập VINADES.,JSC để xây dựng mã nguồn mở hàng đầu cho Việt Nam.', 'tuyendung-kythuat.jpg', 'Tuyển dụng', 1, 1, '6', 1, 0, 0, 0, 0, 0, 0, '', 0),
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_sources`
--

CREATE TABLE `biv_vi_news_sources` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_sources`
--

INSERT INTO `biv_vi_news_sources` (`sourceid`, `title`, `link`, `logo`, `weight`, `add_time`, `edit_time`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_tags`
--

CREATE TABLE `biv_vi_news_tags` (
  `tid` mediumint UNSIGNED NOT NULL,
  `numnews` mediumint NOT NULL DEFAULT '0',
  `title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_tags`
--

INSERT INTO `biv_vi_news_tags` (`tid`, `numnews`, `title`, `alias`, `image`, `description`, `keywords`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_tags_id`
--

CREATE TABLE `biv_vi_news_tags_id` (
  `id` int NOT NULL,
  `tid` mediumint NOT NULL,
  `keyword` varchar(65) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_tags_id`
--

INSERT INTO `biv_vi_news_tags_id` (`id`, `tid`, `keyword`) VALUES
(1, 7, 'thương mại điện'),
(1, 9, 'nukeviet'),
(1, 41, 'module'),
(1, 16, 'mã nguồn mở'),
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_tmp`
--

CREATE TABLE `biv_vi_news_tmp` (
  `id` mediumint UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `biv_vi_news_topics`
--

CREATE TABLE `biv_vi_news_topics` (
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_news_topics`
--

INSERT INTO `biv_vi_news_topics` (`topicid`, `title`, `alias`, `image`, `description`, `weight`, `keywords`, `add_time`, `edit_time`) VALUES
(1, 'NukeViet 4', 'NukeViet-4', '', 'NukeViet 4', 1, 'NukeViet 4', 1445396011, 1445396011);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_page`
--

CREATE TABLE `biv_vi_page` (
  `id` mediumint UNSIGNED NOT NULL,
  `title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alias` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
...
--
-- Cấu trúc bảng cho bảng `biv_vi_page_config`
--

CREATE TABLE `biv_vi_page_config` (
  `config_name` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `config_value` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `biv_vi_page_config`
--

INSERT INTO `biv_vi_page_config` (`config_name`, `config_value`) VALUES
('viewtype', '0'),
('facebookapi', ''),
('per_page', '20'),
('news_first', '0'),
...
--
-- Cấu trúc bảng cho bảng `biv_vi_referer_stats`
--

CREATE TABLE `biv_vi_referer_stats` (
...
--
-- Cấu trúc bảng cho bảng `biv_vi_searchkeys`
--

CREATE TABLE `biv_vi_searchkeys` (
...
--
-- Cấu trúc bảng cho bảng `biv_vi_siteterms`
--

CREATE TABLE `biv_vi_siteterms` (
  `id` mediumint UNSIGNED NOT NULL,
  `title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alias` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
...
--
-- Cấu trúc bảng cho bảng `biv_vi_slider_blocks`
--

CREATE TABLE `biv_vi_slider_blocks` (
  `bid` mediumint UNSIGNED NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `description` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_slider_blocks`
--

INSERT INTO `biv_vi_slider_blocks` (`bid`, `title`, `description`) VALUES
(1, 'Home slider', 'Silder trang chủ');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_slider_rows`
--

CREATE TABLE `biv_vi_slider_rows` (
  `id` mediumint UNSIGNED NOT NULL,
  `bid` mediumint UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `description` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_slider_rows`
--

INSERT INTO `biv_vi_slider_rows` (`id`, `bid`, `title`, `description`, `link`, `target`, `image`, `start_time`, `end_time`, `status`) VALUES
(1, 1, 'Ảnh 1', '', '', '_blank', 'baner-ba-na-hills1-cau-vang.jpg', 1652779991, 0, 1),
(2, 1, 'Ảnh 2', '', '', '_blank', 'tour-bana-hills-combo-uu-dai-banner-thang-5-1536x584.jpg', 1652780005, 0, 1),
(3, 1, 'Ảnh 3', '', '', '_blank', 'baner-tour-bana-hills-2020.jpg', 1652780015, 0, 1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_trang_chu`
--

CREATE TABLE `biv_vi_trang_chu` (
  `id` mediumint UNSIGNED NOT NULL,
  `title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alias` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
...
--
-- Cấu trúc bảng cho bảng `biv_vi_trang_chu_config`
--

CREATE TABLE `biv_vi_trang_chu_config` (
  `config_name` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `config_value` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `biv_vi_trang_chu_config`
--

INSERT INTO `biv_vi_trang_chu_config` (`config_name`, `config_value`) VALUES
('viewtype', '0'),
('facebookapi', ''),
('per_page', '20'),
('news_first', '0'),
...
--
-- Cấu trúc bảng cho bảng `biv_vi_voting`
--

CREATE TABLE `biv_vi_voting` (
  ...
  `exp_time` int UNSIGNED NOT NULL DEFAULT '0',
  `act` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `vote_one` tinyint UNSIGNED NOT NULL DEFAULT '0' COMMENT '0 cho phép vote nhiều lần 1 cho phép vote 1 lần'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `biv_vi_voting`
--

INSERT INTO `biv_vi_voting` (`vid`, `question`, `link`, `acceptcm`, `active_captcha`, `admin_id`, `groups_view`, `publ_time`, `exp_time`, `act`, `vote_one`) VALUES
(2, 'Bạn biết gì về NukeViet 4?', '', 1, 0, 1, '6', 1652690495, 0, 1, 0),
(3, 'Lợi ích của phần mềm nguồn mở là gì?', '', 1, 0, 1, '6', 1652690495, 0, 1, 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `biv_vi_voting_rows`
--

CREATE TABLE `biv_vi_voting_rows` (
  `id` mediumint UNSIGNED NOT NULL,
  `vid` smallint UNSIGNED NOT NULL,
  `title` varchar(245) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Đang đổ dữ liệu cho bảng `biv_vi_voting_rows`
--

INSERT INTO `biv_vi_voting_rows` (`id`, `vid`, `title`, `url`, `hitstotal`) VALUES
...
--
-- Cấu trúc bảng cho bảng `biv_vi_voting_voted`
--

CREATE TABLE `biv_vi_voting_voted` (
  `vid` smallint UNSIGNED NOT NULL,
...
--
-- Chỉ mục cho bảng `biv_authors`
--
ALTER TABLE `biv_authors`
  ADD PRIMARY KEY (`admin_id`);

--
-- Chỉ mục cho bảng `biv_authors_api_credential`
--
ALTER TABLE `biv_authors_api_credential`
  ADD UNIQUE KEY `credential_ident` (`credential_ident`),
  ADD UNIQUE KEY `credential_secret` (`credential_secret`),
  ADD KEY `admin_id` (`admin_id`);

--
-- Chỉ mục cho bảng `biv_authors_api_role`
--
ALTER TABLE `biv_authors_api_role`
  ADD PRIMARY KEY (`role_id`);

--
-- Chỉ mục cho bảng `biv_authors_config`
--
ALTER TABLE `biv_authors_config`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `keyname` (`keyname`);

--
-- Chỉ mục cho bảng `biv_authors_module`
--
ALTER TABLE `biv_authors_module`
  ADD PRIMARY KEY (`mid`),
  ADD UNIQUE KEY `module` (`module`);

--
-- Chỉ mục cho bảng `biv_authors_oauth`
--
ALTER TABLE `biv_authors_oauth`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `admin_id` (`admin_id`,`oauth_server`,`oauth_uid`),
  ADD KEY `oauth_email` (`oauth_email`);

--
-- Chỉ mục cho bảng `biv_banners_click`
--
ALTER TABLE `biv_banners_click`
  ADD PRIMARY KEY (`id`),
  ADD KEY `bid` (`bid`),
...
--
-- Chỉ mục cho bảng `biv_banners_plans`
--
ALTER TABLE `biv_banners_plans`
  ADD PRIMARY KEY (`id`),
  ADD KEY `title` (`title`);

--
-- Chỉ mục cho bảng `biv_banners_rows`
--
ALTER TABLE `biv_banners_rows`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pid` (`pid`),
  ADD KEY `clid` (`clid`);

--
-- Chỉ mục cho bảng `biv_config`
--
ALTER TABLE `biv_config`
  ADD UNIQUE KEY `lang` (`lang`,`module`,`config_name`);

--
-- Chỉ mục cho bảng `biv_cookies`
--
ALTER TABLE `biv_cookies`
  ADD UNIQUE KEY `cookiename` (`name`,`domain`,`path`),
  ADD KEY `name` (`name`);

--
-- Chỉ mục cho bảng `biv_counter`
--
ALTER TABLE `biv_counter`
  ADD UNIQUE KEY `c_type` (`c_type`,`c_val`);

--
-- Chỉ mục cho bảng `biv_cronjobs`
--
ALTER TABLE `biv_cronjobs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `is_sys` (`is_sys`);

--
-- Chỉ mục cho bảng `biv_extension_files`
--
ALTER TABLE `biv_extension_files`
  ADD PRIMARY KEY (`idfile`);

--
-- Chỉ mục cho bảng `biv_ips`
--
ALTER TABLE `biv_ips`
  ADD PRIMARY KEY (`id`),
...
--
-- Chỉ mục cho bảng `biv_language`
--
ALTER TABLE `biv_language`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `filelang` (`idfile`,`lang_key`,`langtype`);

--
-- Chỉ mục cho bảng `biv_language_file`
--
ALTER TABLE `biv_language_file`
  ADD PRIMARY KEY (`idfile`),
  ADD UNIQUE KEY `module` (`module`,`admin_file`);

--
-- Chỉ mục cho bảng `biv_location_country`
--
ALTER TABLE `biv_location_country`
  ADD PRIMARY KEY (`countryid`),
  ADD UNIQUE KEY `countryid` (`code`);

--
-- Chỉ mục cho bảng `biv_location_district`
--
ALTER TABLE `biv_location_district`
  ADD PRIMARY KEY (`districtid`),
  ADD KEY `provinceid` (`provinceid`);

--
-- Chỉ mục cho bảng `biv_location_province`
--
ALTER TABLE `biv_location_province`
  ADD PRIMARY KEY (`provinceid`);

--
-- Chỉ mục cho bảng `biv_location_ward`
--
ALTER TABLE `biv_location_ward`
...
--
-- Chỉ mục cho bảng `biv_logs`
--
ALTER TABLE `biv_logs`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_notification`
--
ALTER TABLE `biv_notification`
  ADD PRIMARY KEY (`id`),
...
--
-- Chỉ mục cho bảng `biv_plugin`
--
ALTER TABLE `biv_plugin`
  ADD PRIMARY KEY (`pid`),
  ADD UNIQUE KEY `plugin_file` (`plugin_file`);

--
-- Chỉ mục cho bảng `biv_sessions`
--
ALTER TABLE `biv_sessions`
  ADD UNIQUE KEY `session_id` (`session_id`),
  ADD KEY `onl_time` (`onl_time`);

--
-- Chỉ mục cho bảng `biv_setup_extensions`
--
ALTER TABLE `biv_setup_extensions`
  ADD UNIQUE KEY `title` (`type`,`title`),
  ADD KEY `id` (`id`),
  ADD KEY `type` (`type`);

--
-- Chỉ mục cho bảng `biv_setup_language`
--
ALTER TABLE `biv_setup_language`
  ADD PRIMARY KEY (`lang`);

--
-- Chỉ mục cho bảng `biv_shops_block`
--
ALTER TABLE `biv_shops_block`
  ADD UNIQUE KEY `bid` (`bid`,`id`);

--
-- Chỉ mục cho bảng `biv_shops_block_cat`
--
ALTER TABLE `biv_shops_block_cat`
  ADD PRIMARY KEY (`bid`),
  ADD UNIQUE KEY `vi_alias` (`vi_alias`);

--
-- Chỉ mục cho bảng `biv_shops_carrier`
--
ALTER TABLE `biv_shops_carrier`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_shops_carrier_config`
--
ALTER TABLE `biv_shops_carrier_config`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_shops_carrier_config_items`
--
ALTER TABLE `biv_shops_carrier_config_items`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_shops_carrier_config_location`
--
ALTER TABLE `biv_shops_carrier_config_location`
  ADD UNIQUE KEY `cid` (`cid`,`lid`);

--
-- Chỉ mục cho bảng `biv_shops_catalogs`
--
ALTER TABLE `biv_shops_catalogs`
  ADD PRIMARY KEY (`catid`),
  ADD UNIQUE KEY `vi_alias` (`vi_alias`),
  ADD KEY `parentid` (`parentid`);

--
-- Chỉ mục cho bảng `biv_shops_coupons`
--
ALTER TABLE `biv_shops_coupons`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_shops_coupons_history`
--
ALTER TABLE `biv_shops_coupons_history`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_shops_coupons_product`
--
ALTER TABLE `biv_shops_coupons_product`
  ADD UNIQUE KEY `cid` (`cid`,`pid`);

--
-- Chỉ mục cho bảng `biv_shops_discounts`
--
ALTER TABLE `biv_shops_discounts`
  ADD PRIMARY KEY (`did`),
  ADD KEY `begin_time` (`begin_time`,`end_time`);

--
-- Chỉ mục cho bảng `biv_shops_field`
--
ALTER TABLE `biv_shops_field`
  ADD PRIMARY KEY (`fid`),
  ADD UNIQUE KEY `field` (`field`);

--
-- Chỉ mục cho bảng `biv_shops_field_value_vi`
--
ALTER TABLE `biv_shops_field_value_vi`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `rows_id` (`rows_id`,`field_id`);

--
-- Chỉ mục cho bảng `biv_shops_files`
--
ALTER TABLE `biv_shops_files`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_shops_files_rows`
--
ALTER TABLE `biv_shops_files_rows`
  ADD UNIQUE KEY `id_files` (`id_files`,`id_rows`);

--
-- Chỉ mục cho bảng `biv_shops_group`
--
ALTER TABLE `biv_shops_group`
  ADD PRIMARY KEY (`groupid`),
  ADD UNIQUE KEY `vi_alias` (`vi_alias`),
  ADD KEY `parentid` (`parentid`);

--
-- Chỉ mục cho bảng `biv_shops_group_cateid`
--
ALTER TABLE `biv_shops_group_cateid`
  ADD UNIQUE KEY `groupid` (`groupid`,`cateid`);

--
-- Chỉ mục cho bảng `biv_shops_group_items`
--
ALTER TABLE `biv_shops_group_items`
  ADD PRIMARY KEY (`pro_id`,`group_id`),
  ADD KEY `pro_id` (`pro_id`),
  ADD KEY `group_id` (`group_id`);

--
-- Chỉ mục cho bảng `biv_shops_group_quantity`
--
ALTER TABLE `biv_shops_group_quantity`
  ADD UNIQUE KEY `pro_id` (`pro_id`,`listgroup`);

--
-- Chỉ mục cho bảng `biv_shops_location`
--
ALTER TABLE `biv_shops_location`
  ADD PRIMARY KEY (`id`),
  ADD KEY `parentid` (`parentid`);

--
-- Chỉ mục cho bảng `biv_shops_money_vi`
--
ALTER TABLE `biv_shops_money_vi`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Chỉ mục cho bảng `biv_shops_orders`
--
ALTER TABLE `biv_shops_orders`
...
--
-- Chỉ mục cho bảng `biv_shops_orders_id`
--
ALTER TABLE `biv_shops_orders_id`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `orderid` (`order_id`,`id`);

--
-- Chỉ mục cho bảng `biv_shops_orders_id_group`
--
ALTER TABLE `biv_shops_orders_id_group`
  ADD UNIQUE KEY `orderid` (`order_i`,`group_id`);

--
-- Chỉ mục cho bảng `biv_shops_orders_shipping`
--
ALTER TABLE `biv_shops_orders_shipping`
  ADD PRIMARY KEY (`id`),
  ADD KEY `add_time` (`add_time`);

--
-- Chỉ mục cho bảng `biv_shops_point`
--
ALTER TABLE `biv_shops_point`
  ADD PRIMARY KEY (`userid`);

--
-- Chỉ mục cho bảng `biv_shops_point_history`
--
ALTER TABLE `biv_shops_point_history`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_shops_review`
--
ALTER TABLE `biv_shops_review`
  ADD PRIMARY KEY (`review_id`);

--
-- Chỉ mục cho bảng `biv_shops_rows`
--
ALTER TABLE `biv_shops_rows`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `vi_alias` (`vi_alias`),
...
--
-- Chỉ mục cho bảng `biv_shops_shops`
--
ALTER TABLE `biv_shops_shops`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_shops_shops_carrier`
--
ALTER TABLE `biv_shops_shops_carrier`
  ADD UNIQUE KEY `shops_id` (`shops_id`,`carrier_id`);

--
-- Chỉ mục cho bảng `biv_shops_tabs`
--
ALTER TABLE `biv_shops_tabs`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_shops_tags_id_vi`
--
ALTER TABLE `biv_shops_tags_id_vi`
  ADD UNIQUE KEY `sid` (`id`,`tid`),
  ADD KEY `tid` (`tid`);

--
-- Chỉ mục cho bảng `biv_shops_tags_vi`
--
ALTER TABLE `biv_shops_tags_vi`
  ADD PRIMARY KEY (`tid`),
  ADD UNIQUE KEY `alias` (`alias`);

--
-- Chỉ mục cho bảng `biv_shops_template`
--
ALTER TABLE `biv_shops_template`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `alias` (`alias`);

--
-- Chỉ mục cho bảng `biv_shops_transaction`
--
ALTER TABLE `biv_shops_transaction`
  ADD PRIMARY KEY (`transaction_id`),
  ADD KEY `order_id` (`order_id`),
  ADD KEY `payment_id` (`payment_id`);

--
-- Chỉ mục cho bảng `biv_shops_units`
--
ALTER TABLE `biv_shops_units`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_shops_warehouse`
--
ALTER TABLE `biv_shops_warehouse`
  ADD PRIMARY KEY (`wid`);

--
-- Chỉ mục cho bảng `biv_shops_warehouse_logs`
--
ALTER TABLE `biv_shops_warehouse_logs`
  ADD PRIMARY KEY (`logid`),
  ADD KEY `wid` (`wid`);

--
-- Chỉ mục cho bảng `biv_shops_warehouse_logs_group`
--
ALTER TABLE `biv_shops_warehouse_logs_group`
  ADD PRIMARY KEY (`id`),
  ADD KEY `logid` (`logid`);

--
-- Chỉ mục cho bảng `biv_shops_weight_vi`
--
ALTER TABLE `biv_shops_weight_vi`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Chỉ mục cho bảng `biv_shops_wishlist`
--
ALTER TABLE `biv_shops_wishlist`
  ADD PRIMARY KEY (`wid`);

--
-- Chỉ mục cho bảng `biv_upload_dir`
--
ALTER TABLE `biv_upload_dir`
  ADD PRIMARY KEY (`did`),
  ADD UNIQUE KEY `name` (`dirname`);

--
-- Chỉ mục cho bảng `biv_upload_file`
--
ALTER TABLE `biv_upload_file`
  ADD UNIQUE KEY `did` (`did`,`title`),
  ADD KEY `userid` (`userid`),
  ADD KEY `type` (`type`);

--
-- Chỉ mục cho bảng `biv_users`
--
ALTER TABLE `biv_users`
  ADD PRIMARY KEY (`userid`),
...
--
-- Chỉ mục cho bảng `biv_users_backupcodes`
--
ALTER TABLE `biv_users_backupcodes`
  ADD UNIQUE KEY `userid` (`userid`,`code`);

--
-- Chỉ mục cho bảng `biv_users_config`
--
ALTER TABLE `biv_users_config`
  ADD PRIMARY KEY (`config`);

--
-- Chỉ mục cho bảng `biv_users_edit`
--
ALTER TABLE `biv_users_edit`
  ADD PRIMARY KEY (`userid`);

--
-- Chỉ mục cho bảng `biv_users_field`
--
ALTER TABLE `biv_users_field`
  ADD PRIMARY KEY (`fid`),
  ADD UNIQUE KEY `field` (`field`);

--
-- Chỉ mục cho bảng `biv_users_groups`
--
ALTER TABLE `biv_users_groups`
  ADD PRIMARY KEY (`group_id`),
  ADD UNIQUE KEY `kalias` (`alias`,`idsite`),
  ADD KEY `exp_time` (`exp_time`);

--
-- Chỉ mục cho bảng `biv_users_groups_detail`
--
ALTER TABLE `biv_users_groups_detail`
  ADD UNIQUE KEY `group_id_lang` (`lang`,`group_id`);

--
-- Chỉ mục cho bảng `biv_users_groups_users`
--
ALTER TABLE `biv_users_groups_users`
  ADD PRIMARY KEY (`group_id`,`userid`);

--
-- Chỉ mục cho bảng `biv_users_info`
--
ALTER TABLE `biv_users_info`
  ADD PRIMARY KEY (`userid`);

--
-- Chỉ mục cho bảng `biv_users_openid`
--
ALTER TABLE `biv_users_openid`
  ADD UNIQUE KEY `opid` (`openid`,`opid`),
  ADD KEY `userid` (`userid`),
  ADD KEY `email` (`email`);

--
-- Chỉ mục cho bảng `biv_users_question`
--
ALTER TABLE `biv_users_question`
  ADD PRIMARY KEY (`qid`),
  ADD UNIQUE KEY `title` (`title`,`lang`);

--
-- Chỉ mục cho bảng `biv_users_reg`
--
ALTER TABLE `biv_users_reg`
  ADD PRIMARY KEY (`userid`),
...
--
-- Chỉ mục cho bảng `biv_vi_about`
--
ALTER TABLE `biv_vi_about`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `alias` (`alias`);

--
-- Chỉ mục cho bảng `biv_vi_about_config`
--
ALTER TABLE `biv_vi_about_config`
  ADD UNIQUE KEY `config_name` (`config_name`);

--
-- Chỉ mục cho bảng `biv_vi_blocks_groups`
--
ALTER TABLE `biv_vi_blocks_groups`
  ADD PRIMARY KEY (`bid`),
  ADD KEY `theme` (`theme`),
...
--
-- Chỉ mục cho bảng `biv_vi_blocks_weight`
--
ALTER TABLE `biv_vi_blocks_weight`
  ADD UNIQUE KEY `bid` (`bid`,`func_id`);

--
-- Chỉ mục cho bảng `biv_vi_comment`
--
ALTER TABLE `biv_vi_comment`
  ADD PRIMARY KEY (`cid`),
  ADD KEY `mod_id` (`module`,`area`,`id`),
  ADD KEY `post_time` (`post_time`);

--
-- Chỉ mục cho bảng `biv_vi_contact_department`
--
ALTER TABLE `biv_vi_contact_department`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `full_name` (`full_name`),
  ADD UNIQUE KEY `alias` (`alias`);

--
-- Chỉ mục cho bảng `biv_vi_contact_reply`
--
ALTER TABLE `biv_vi_contact_reply`
  ADD PRIMARY KEY (`rid`),
  ADD KEY `id` (`id`);

--
-- Chỉ mục cho bảng `biv_vi_contact_send`
--
ALTER TABLE `biv_vi_contact_send`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sender_name` (`sender_name`);

--
-- Chỉ mục cho bảng `biv_vi_contact_supporter`
--
ALTER TABLE `biv_vi_contact_supporter`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_vi_freecontent_blocks`
--
ALTER TABLE `biv_vi_freecontent_blocks`
  ADD PRIMARY KEY (`bid`);

--
-- Chỉ mục cho bảng `biv_vi_freecontent_rows`
--
ALTER TABLE `biv_vi_freecontent_rows`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_vi_menu`
--
ALTER TABLE `biv_vi_menu`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Chỉ mục cho bảng `biv_vi_menu_rows`
--
ALTER TABLE `biv_vi_menu_rows`
  ADD PRIMARY KEY (`id`),
  ADD KEY `parentid` (`parentid`,`mid`);

--
-- Chỉ mục cho bảng `biv_vi_modfuncs`
--
ALTER TABLE `biv_vi_modfuncs`
  ADD PRIMARY KEY (`func_id`),
  ADD UNIQUE KEY `func_name` (`func_name`,`in_module`),
  ADD UNIQUE KEY `alias` (`alias`,`in_module`);

--
-- Chỉ mục cho bảng `biv_vi_modthemes`
--
ALTER TABLE `biv_vi_modthemes`
  ADD UNIQUE KEY `func_id` (`func_id`,`layout`,`theme`);

--
-- Chỉ mục cho bảng `biv_vi_modules`
--
ALTER TABLE `biv_vi_modules`
  ADD PRIMARY KEY (`title`);

--
-- Chỉ mục cho bảng `biv_vi_news_1`
--
ALTER TABLE `biv_vi_news_1`
  ADD PRIMARY KEY (`id`),
  ADD KEY `catid` (`catid`),
...
--
-- Chỉ mục cho bảng `biv_vi_news_2`
--
ALTER TABLE `biv_vi_news_2`
  ADD PRIMARY KEY (`id`),
  ADD KEY `catid` (`catid`),
  ADD KEY `topicid` (`topicid`),
  ADD KEY `admin_id` (`admin_id`),
...
--
-- Chỉ mục cho bảng `biv_vi_news_3`
--
ALTER TABLE `biv_vi_news_3`
  ADD PRIMARY KEY (`id`),
  ADD KEY `catid` (`catid`),
  ADD KEY `topicid` (`topicid`),
  ADD KEY `admin_id` (`admin_id`),
...
--
-- Chỉ mục cho bảng `biv_vi_news_4`
--
ALTER TABLE `biv_vi_news_4`
  ADD PRIMARY KEY (`id`),
  ADD KEY `catid` (`catid`),
  ADD KEY `topicid` (`topicid`),
  ADD KEY `admin_id` (`admin_id`),
...
--
-- Chỉ mục cho bảng `biv_vi_news_5`
--
ALTER TABLE `biv_vi_news_5`
  ADD PRIMARY KEY (`id`),
  ADD KEY `catid` (`catid`),
  ADD KEY `topicid` (`topicid`),
  ADD KEY `admin_id` (`admin_id`),
...
--
-- Chỉ mục cho bảng `biv_vi_news_6`
--
ALTER TABLE `biv_vi_news_6`
  ADD PRIMARY KEY (`id`),
  ADD KEY `catid` (`catid`),
  ADD KEY `topicid` (`topicid`),
  ADD KEY `admin_id` (`admin_id`),
...
--
-- Chỉ mục cho bảng `biv_vi_news_7`
--
ALTER TABLE `biv_vi_news_7`
  ADD PRIMARY KEY (`id`),
  ADD KEY `catid` (`catid`),
  ADD KEY `topicid` (`topicid`),
  ADD KEY `admin_id` (`admin_id`),
...
--
-- Chỉ mục cho bảng `biv_vi_news_admins`
--
ALTER TABLE `biv_vi_news_admins`
  ADD UNIQUE KEY `userid` (`userid`,`catid`);

--
-- Chỉ mục cho bảng `biv_vi_news_author`
--
ALTER TABLE `biv_vi_news_author`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uid` (`uid`),
  ADD UNIQUE KEY `alias` (`alias`);

--
-- Chỉ mục cho bảng `biv_vi_news_authorlist`
--
ALTER TABLE `biv_vi_news_authorlist`
  ADD UNIQUE KEY `id_aid` (`id`,`aid`),
  ADD KEY `aid` (`aid`),
  ADD KEY `alias` (`alias`);

--
-- Chỉ mục cho bảng `biv_vi_news_block`
--
ALTER TABLE `biv_vi_news_block`
  ADD UNIQUE KEY `bid` (`bid`,`id`);

--
-- Chỉ mục cho bảng `biv_vi_news_block_cat`
--
ALTER TABLE `biv_vi_news_block_cat`
  ADD PRIMARY KEY (`bid`),
  ADD UNIQUE KEY `title` (`title`),
  ADD UNIQUE KEY `alias` (`alias`);

--
-- Chỉ mục cho bảng `biv_vi_news_cat`
--
ALTER TABLE `biv_vi_news_cat`
  ADD PRIMARY KEY (`catid`),
  ADD UNIQUE KEY `alias` (`alias`),
  ADD KEY `parentid` (`parentid`),
  ADD KEY `status` (`status`);
...
--
-- Chỉ mục cho bảng `biv_vi_news_config_post`
--
ALTER TABLE `biv_vi_news_config_post`
  ADD PRIMARY KEY (`group_id`);

--
-- Chỉ mục cho bảng `biv_vi_news_detail`
--
ALTER TABLE `biv_vi_news_detail`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_vi_news_logs`
--
ALTER TABLE `biv_vi_news_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sid` (`sid`),
  ADD KEY `userid` (`userid`);

--
-- Chỉ mục cho bảng `biv_vi_news_rows`
--
ALTER TABLE `biv_vi_news_rows`
  ADD PRIMARY KEY (`id`),
  ADD KEY `catid` (`catid`),
  ADD KEY `topicid` (`topicid`),
  ADD KEY `admin_id` (`admin_id`),
...
--
-- Chỉ mục cho bảng `biv_vi_news_sources`
--
ALTER TABLE `biv_vi_news_sources`
  ADD PRIMARY KEY (`sourceid`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Chỉ mục cho bảng `biv_vi_news_tags`
--
ALTER TABLE `biv_vi_news_tags`
  ADD PRIMARY KEY (`tid`),
  ADD UNIQUE KEY `alias` (`alias`);

--
-- Chỉ mục cho bảng `biv_vi_news_tags_id`
--
ALTER TABLE `biv_vi_news_tags_id`
  ADD UNIQUE KEY `id_tid` (`id`,`tid`),
  ADD KEY `tid` (`tid`);

--
-- Chỉ mục cho bảng `biv_vi_news_tmp`
--
ALTER TABLE `biv_vi_news_tmp`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_vi_news_topics`
--
ALTER TABLE `biv_vi_news_topics`
  ADD PRIMARY KEY (`topicid`),
  ADD UNIQUE KEY `title` (`title`),
  ADD UNIQUE KEY `alias` (`alias`);

--
-- Chỉ mục cho bảng `biv_vi_page`
--
ALTER TABLE `biv_vi_page`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `alias` (`alias`);

--
-- Chỉ mục cho bảng `biv_vi_page_config`
--
ALTER TABLE `biv_vi_page_config`
  ADD UNIQUE KEY `config_name` (`config_name`);

--
-- Chỉ mục cho bảng `biv_vi_referer_stats`
--
ALTER TABLE `biv_vi_referer_stats`
  ADD UNIQUE KEY `host` (`host`),
  ADD KEY `total` (`total`);

--
-- Chỉ mục cho bảng `biv_vi_searchkeys`
--
ALTER TABLE `biv_vi_searchkeys`
  ADD KEY `id` (`id`),
  ADD KEY `skey` (`skey`),
  ADD KEY `search_engine` (`search_engine`);

--
-- Chỉ mục cho bảng `biv_vi_siteterms`
--
ALTER TABLE `biv_vi_siteterms`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `alias` (`alias`);

--
-- Chỉ mục cho bảng `biv_vi_siteterms_config`
--
ALTER TABLE `biv_vi_siteterms_config`
  ADD UNIQUE KEY `config_name` (`config_name`);

--
-- Chỉ mục cho bảng `biv_vi_slider_blocks`
--
ALTER TABLE `biv_vi_slider_blocks`
  ADD PRIMARY KEY (`bid`);

--
-- Chỉ mục cho bảng `biv_vi_slider_rows`
--
ALTER TABLE `biv_vi_slider_rows`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `biv_vi_trang_chu`
--
ALTER TABLE `biv_vi_trang_chu`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `alias` (`alias`);

--
-- Chỉ mục cho bảng `biv_vi_trang_chu_config`
--
ALTER TABLE `biv_vi_trang_chu_config`
  ADD UNIQUE KEY `config_name` (`config_name`);

--
-- Chỉ mục cho bảng `biv_vi_voting`
--
ALTER TABLE `biv_vi_voting`
  ADD PRIMARY KEY (`vid`),
  ADD UNIQUE KEY `question` (`question`);

--
-- Chỉ mục cho bảng `biv_vi_voting_rows`
--
ALTER TABLE `biv_vi_voting_rows`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `vid` (`vid`,`title`);

--
-- Chỉ mục cho bảng `biv_vi_voting_voted`
--
ALTER TABLE `biv_vi_voting_voted`
...
--
-- AUTO_INCREMENT cho bảng `biv_authors_api_role`
--
ALTER TABLE `biv_authors_api_role`
  MODIFY `role_id` smallint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_authors_config`
--
ALTER TABLE `biv_authors_config`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_authors_module`
--
ALTER TABLE `biv_authors_module`
  MODIFY `mid` mediumint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `biv_authors_oauth`
--
ALTER TABLE `biv_authors_oauth`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_banners_click`
--
ALTER TABLE `biv_banners_click`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_banners_plans`
--
ALTER TABLE `biv_banners_plans`
  MODIFY `id` smallint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `biv_banners_rows`
--
ALTER TABLE `biv_banners_rows`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `biv_cronjobs`
--
ALTER TABLE `biv_cronjobs`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT cho bảng `biv_extension_files`
--
ALTER TABLE `biv_extension_files`
  MODIFY `idfile` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_ips`
--
ALTER TABLE `biv_ips`
  MODIFY `id` mediumint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `biv_language`
--
ALTER TABLE `biv_language`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_language_file`
--
ALTER TABLE `biv_language_file`
  MODIFY `idfile` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_location_country`
--
ALTER TABLE `biv_location_country`
  MODIFY `countryid` smallint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `biv_location_district`
--
ALTER TABLE `biv_location_district`
  MODIFY `districtid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_location_province`
--
ALTER TABLE `biv_location_province`
  MODIFY `provinceid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_location_ward`
--
ALTER TABLE `biv_location_ward`
  MODIFY `wardid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_logs`
--
ALTER TABLE `biv_logs`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;

--
-- AUTO_INCREMENT cho bảng `biv_notification`
--
ALTER TABLE `biv_notification`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `biv_plugin`
--
ALTER TABLE `biv_plugin`
  MODIFY `pid` tinyint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `biv_shops_block_cat`
--
ALTER TABLE `biv_shops_block_cat`
  MODIFY `bid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `biv_shops_carrier`
--
ALTER TABLE `biv_shops_carrier`
  MODIFY `id` tinyint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_carrier_config`
--
ALTER TABLE `biv_shops_carrier_config`
  MODIFY `id` tinyint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_carrier_config_items`
--
ALTER TABLE `biv_shops_carrier_config_items`
  MODIFY `id` smallint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_catalogs`
--
ALTER TABLE `biv_shops_catalogs`
  MODIFY `catid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT cho bảng `biv_shops_coupons`
--
ALTER TABLE `biv_shops_coupons`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_coupons_history`
--
ALTER TABLE `biv_shops_coupons_history`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_discounts`
--
ALTER TABLE `biv_shops_discounts`
  MODIFY `did` smallint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_field`
--
ALTER TABLE `biv_shops_field`
  MODIFY `fid` mediumint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_field_value_vi`
--
ALTER TABLE `biv_shops_field_value_vi`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_files`
--
ALTER TABLE `biv_shops_files`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_group`
--
ALTER TABLE `biv_shops_group`
  MODIFY `groupid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT cho bảng `biv_shops_location`
--
ALTER TABLE `biv_shops_location`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_orders`
--
ALTER TABLE `biv_shops_orders`
  MODIFY `order_id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_orders_id`
--
ALTER TABLE `biv_shops_orders_id`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_orders_shipping`
--
ALTER TABLE `biv_shops_orders_shipping`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_point_history`
--
ALTER TABLE `biv_shops_point_history`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_review`
--
ALTER TABLE `biv_shops_review`
  MODIFY `review_id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_rows`
--
ALTER TABLE `biv_shops_rows`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `biv_shops_shops`
--
ALTER TABLE `biv_shops_shops`
  MODIFY `id` tinyint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_tabs`
--
ALTER TABLE `biv_shops_tabs`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `biv_shops_tags_vi`
--
ALTER TABLE `biv_shops_tags_vi`
  MODIFY `tid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT cho bảng `biv_shops_template`
--
ALTER TABLE `biv_shops_template`
  MODIFY `id` mediumint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_transaction`
--
ALTER TABLE `biv_shops_transaction`
  MODIFY `transaction_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_shops_units`
--
ALTER TABLE `biv_shops_units`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `biv_shops_warehouse`
--
ALTER TABLE `biv_shops_warehouse`
  MODIFY `wid` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `biv_shops_warehouse_logs`
--
ALTER TABLE `biv_shops_warehouse_logs`
  MODIFY `logid` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `biv_shops_warehouse_logs_group`
--
ALTER TABLE `biv_shops_warehouse_logs_group`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT cho bảng `biv_shops_weight_vi`
--
ALTER TABLE `biv_shops_weight_vi`
  MODIFY `id` tinyint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `biv_shops_wishlist`
--
ALTER TABLE `biv_shops_wishlist`
  MODIFY `wid` smallint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_upload_dir`
--
ALTER TABLE `biv_upload_dir`
  MODIFY `did` mediumint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT cho bảng `biv_users`
--
ALTER TABLE `biv_users`
  MODIFY `userid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `biv_users_backupcodes`
--
ALTER TABLE `biv_users_backupcodes`
  MODIFY `userid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_users_field`
--
ALTER TABLE `biv_users_field`
  MODIFY `fid` mediumint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT cho bảng `biv_users_groups`
--
ALTER TABLE `biv_users_groups`
  MODIFY `group_id` smallint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `biv_users_question`
--
ALTER TABLE `biv_users_question`
  MODIFY `qid` smallint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT cho bảng `biv_users_reg`
--
ALTER TABLE `biv_users_reg`
  MODIFY `userid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_vi_about`
--
ALTER TABLE `biv_vi_about`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT cho bảng `biv_vi_blocks_groups`
--
ALTER TABLE `biv_vi_blocks_groups`
  MODIFY `bid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT cho bảng `biv_vi_comment`
--
ALTER TABLE `biv_vi_comment`
  MODIFY `cid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_vi_contact_department`
--
ALTER TABLE `biv_vi_contact_department`
  MODIFY `id` smallint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `biv_vi_contact_reply`
--
ALTER TABLE `biv_vi_contact_reply`
  MODIFY `rid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_vi_contact_send`
--
ALTER TABLE `biv_vi_contact_send`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `biv_vi_contact_supporter`
--
ALTER TABLE `biv_vi_contact_supporter`
  MODIFY `id` smallint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_vi_freecontent_blocks`
--
ALTER TABLE `biv_vi_freecontent_blocks`
  MODIFY `bid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `biv_vi_freecontent_rows`
--
ALTER TABLE `biv_vi_freecontent_rows`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `biv_vi_menu`
--
ALTER TABLE `biv_vi_menu`
  MODIFY `id` smallint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `biv_vi_menu_rows`
--
ALTER TABLE `biv_vi_menu_rows`
  MODIFY `id` mediumint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT cho bảng `biv_vi_modfuncs`
--
ALTER TABLE `biv_vi_modfuncs`
  MODIFY `func_id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_1`
--
ALTER TABLE `biv_vi_news_1`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_2`
--
ALTER TABLE `biv_vi_news_2`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_3`
--
ALTER TABLE `biv_vi_news_3`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_4`
--
ALTER TABLE `biv_vi_news_4`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_5`
--
ALTER TABLE `biv_vi_news_5`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_6`
--
ALTER TABLE `biv_vi_news_6`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_7`
--
ALTER TABLE `biv_vi_news_7`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_author`
--
ALTER TABLE `biv_vi_news_author`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_block_cat`
--
ALTER TABLE `biv_vi_news_block_cat`
  MODIFY `bid` smallint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_cat`
--
ALTER TABLE `biv_vi_news_cat`
  MODIFY `catid` smallint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_logs`
--
ALTER TABLE `biv_vi_news_logs`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_rows`
--
ALTER TABLE `biv_vi_news_rows`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_sources`
--
ALTER TABLE `biv_vi_news_sources`
  MODIFY `sourceid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_tags`
--
ALTER TABLE `biv_vi_news_tags`
  MODIFY `tid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT cho bảng `biv_vi_news_topics`
--
ALTER TABLE `biv_vi_news_topics`
  MODIFY `topicid` smallint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `biv_vi_page`
--
ALTER TABLE `biv_vi_page`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_vi_siteterms`
--
ALTER TABLE `biv_vi_siteterms`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `biv_vi_slider_blocks`
--
ALTER TABLE `biv_vi_slider_blocks`
  MODIFY `bid` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `biv_vi_slider_rows`
--
ALTER TABLE `biv_vi_slider_rows`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `biv_vi_trang_chu`
--
ALTER TABLE `biv_vi_trang_chu`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `biv_vi_voting`
--
ALTER TABLE `biv_vi_voting`
  MODIFY `vid` smallint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `biv_vi_voting_rows`
--
ALTER TABLE `biv_vi_voting_rows`
