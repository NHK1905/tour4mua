...
if (! nv_function_exists('nv_block_tours_bxslider_carousel')) {
    ...
    function nv_block_config_tours_bxslider_carousel($module, $data_block, $lang_block)
    {
        ...
        if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/tours/block_bxslider_carousel.tpl')) {
        ...
        $xtpl = new XTemplate('block_bxslider_carousel.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/tours');
    ...
    function nv_block_tours_bxslider_carousel($block_config)
    {
        ...
        if (! empty($list)) {
            ...
            $xtpl = new XTemplate('block_cat.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/tours');
